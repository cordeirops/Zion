...
uses
  ...
  IBSQLMonitor, FR_DSet, FR_DBSet, FR_Class, DBClient, MDODatabase,
...
type
  TDMMACS = class(TDataModule)
    ...
    TEmpresaALIQICMS: TIBBCDField;
    TEmpresaINDUSTRIA: TIBStringField;
    TEmpresaNCI: TIBStringField;
    TCodigoCOD_OBRA: TIntegerField;
    TEmpresaDTCONFATUAL: TDateField;
    ...
    TMPVLR8: TIBBCDField;
    TMPVLR9: TIBBCDField;
    //TMPVLR10: TIBBCDField;
    //TMPVLR11: TIBBCDField;
    //TMPVLR12: TIBBCDField;
    //TMPVLR13: TIBBCDField;
    //TMPVLR14: TIBBCDField;
    TMPVLR10: TIBBCDField;
    TMPVLR11: TIBBCDField;
    TMPVLR12: TIBBCDField;
    TMPVLR13: TIBBCDField;
    ...
    TMPVLR15: TIBBCDField;
    TMPVLR16: TIBBCDField;
    TMPOBS: TMemoField;
    TEmpresaNAOCALCST: TIBStringField;
    TEmpresaEMEXPORTA: TIBStringField;
    TPeriodoFiscal: TIBQuery;
    UPeriodoFiscal: TIBUpdateSQL;
    DPeriodoFiscal: TDataSource;
    TPeriodoFiscalCOD_PERIODOFISCAL: TIntegerField;
    TPeriodoFiscalDESCRICAO: TIBStringField;
    TPeriodoFiscalDTINICIAL: TDateField;
    TPeriodoFiscalDTFINAL: TDateField;
    TPeriodoFiscalFECHADO: TIBStringField;
    DsNovidades: TDataSource;
    TNovidades: TClientDataSet;
    TNovidadessNoticias: TStringField;
    TNovidadessUrls: TStringField;
    TNovidadessTipoFiltro: TStringField;
    TNovidadessFiltro: TStringField;
    ...
    TLojaINDCFOPINTERNO: TIntegerField;
    TLojaINDCFOPEXTERNO: TIntegerField;
    TLojaDESATIVASITE: TIBStringField;
    TLojaDESATIVAFEED: TIBStringField;
    TLojaATIVAGRID: TIBStringField;
    TLojaATIVACONSULTARAP: TIBStringField;
    TLojaDESCETIQUETA: TIBStringField;
    TLojaCHECKEXPRESS: TIBStringField;
    TLojaCOD_CFOPDEVFORA: TIntegerField;
    TLojaGERACTAROUTROS: TIBStringField;
    TLojaINFDIASVENCLOTE: TIntegerField;
    TLojaRESERVFISCONF: TIBStringField;
    TLojaNFIMPDADOSVEICULO: TIBStringField;
    TLojaNFIMPOBS: TIBStringField;
    TLojaNFIMPNUMORD: TIBStringField;
    TLojaPADMECDOCFIN: TIBStringField;
    TLojaPROXDOCPADMEC: TIntegerField;
    TLojaPESQINTELPROD: TIBStringField;
    TLojaCONTROLPRODLISTA: TIBStringField;
    TLojaCFOPINTSERV: TIntegerField;
    TLojaCFOPEXTSERV: TIntegerField;
    TLojaLIBERACATALOGO: TIBStringField;
    TLojaABRECATALOGO: TIBStringField;
    TLojaNUMREGISTROSSQL: TSmallintField;
    TLojaCONCTELCONTATO: TIBStringField;
    TLojaINFOPROMISSORIA: TIBStringField;
    TLojaATIVAPROMISSORIA: TIBStringField;
    TLojaDUPLICAPROMIS: TIBStringField;
    TLojaCOMPLEMENTARBLT: TIBStringField;
    TLojaJUROMULTABLT: TIBStringField;
    TLojaABREFICHATEC: TIBStringField;
    TLojaRAZAOPROMISSORIA: TIBStringField;
    TLojaENDLOJAPROMISSORIA: TIBStringField;
    TLojaTXTRESERVFISCONF: TIBStringField;
    TLojaMOSTRACUSTOPEDV: TIBStringField;
    TLojaCFOPINTPC: TIntegerField;
    TLojaCFOPEXTPC: TIntegerField;
    TLojaCFOPINTSTPC: TIntegerField;
    TLojaCFOPEXTSTPC: TIntegerField;
    TLojaCFOPINTGARANTIA: TIntegerField;
    TLojaCFOPEXTGARANTIA: TIntegerField;
    TLojaCFOPINTDEVOLUC: TIntegerField;
    TLojaCFOPEXTDEVOLUC: TIntegerField;
    TLojaCFOPINTDEVOLUCST: TIntegerField;
    TLojaCFOPEXTDEVOLUCST: TIntegerField;
    TLojaUSAOBSITEMCOMPRA: TIBStringField;
    TLojaCFOPMATCONSUMO: TIntegerField;
    TLojaMODELOCOMPPEDC: TSmallintField;
    TLojaIMPNOMEEQUIPECOMPORDEM: TIBStringField;
    TLojaCFOPMATCONSUMOEXT: TIntegerField;
    TLojaATUALIZABANCO: TIBStringField;
    TLojaHOSTFTP: TIBStringField;
    TLojaUSERNAMEFTP: TIBStringField;
    TLojaPASSWORDFTP: TIBStringField;
    TLojaDIRDOWFTP: TIBStringField;
    TLojaDIRUPFTP: TIBStringField;
    TLojaHORAFTP: TIBStringField;
    TLojaFECHARCOMPRANF: TIBStringField;
    TLojaCFOPINTSIMPREMESSA: TIntegerField;
    TLojaCFOPEXTSIMPREMESSA: TIntegerField;
    TLojaCRIAARQFTP: TIBStringField;
    TLojaRECEBEARQFTP: TIBStringField;
    TLojaATUALIZABANCOAUT: TIBStringField;
    TLojaDATAFTP: TDateField;
    TLojaCFOPFRETEINT: TIntegerField;
    TLojaCFOPFRETEEXT: TIntegerField;
    TLojaIMPEDIRSERVICOS: TIBStringField;
    TLojaGERAFINANCDTSIS: TIBStringField;
    TLojaCOD_DEVNOTAPROPDENTRO: TIntegerField;
    TLojaCOD_DEVNOTAPROPFORA: TSmallintField;
    TLojaCSTTRIB: TIntegerField;
    TLojaCSTSUBST: TIntegerField;
    TCodigoCOD_PRODUTOSADICIONAIS: TIntegerField;
    TCodigoCOD_VENDAAGRUPADA: TIntegerField;
    TCodigoCOD_ITENVENDAAGRUP: TIntegerField;
    TLojaLOGOEMPRESA: TBlobField;
    TLojaIECLASS2: TIBStringField;
    TLojaIECONTRINT: TIBStringField;
    DSLote: TDataSource;
    TLote: TIBQuery;
    ULote: TIBUpdateSQL;
    TLoteCOD_LOTE: TIntegerField;
    TLoteDTABERTURA: TDateField;
    TLoteDTFECHAMENTO: TDateField;
    TLoteDESCRICAO: TIBStringField;
    TLoteOBSERVACAO: TMemoField;
    TLoteNUMERO: TIntegerField;
    TLoteSTATUS: TIBStringField;
    TCodigoCOD_ESTOQUELOTE: TIntegerField;
    TCodigoCOD_PRODUCAOLOTE: TIntegerField;
    TLojaPLANOCTAPROD: TIBStringField;
    TLojaMOSTRAESTOQUE: TIBStringField;
    TLojaSENHASUPORTE: TIBStringField;
    TLojaCONTROLANCM: TIBStringField;
    TLojaSERVNFE: TIBStringField;
    TLojaNFEVERSAO: TIBStringField;
    TLojaCTRLNUM: TIBStringField;
    TLojaPUXAULTPRONOVO: TIBStringField;
    TLojaPERSODESPADIC: TIBStringField;
    TCodigoCOD_FATURA: TIntegerField;
    TCodigoCOD_PEDFATURADO: TIntegerField;
    TEmpresaCOD_EXPORT: TIntegerField;
    TCodigoCOD_CODBARRA: TIntegerField;
    TLojaFOCUITEMOS: TIBStringField;
    TLojaMOVCAIXACARTAO: TIBStringField;
    TLojaNAOATUALIZAESTOQUEPC: TIBStringField;
    TLojaDIASVENC: TIntegerField;
    TLojaEMISSAOPROPDENTRO: TIntegerField;
    TLojaEMISSAOPROPFORA: TIntegerField;
    TCodigoCOD_VEIC_ENT: TIntegerField;
    TEmpresaPROXNUMSCAN: TIntegerField;
    TEmpresaNFESERIESCAN: TIntegerField;
    TEmpresaAPLICAPISCONFINSSAIDA: TIBStringField;
    TEmpresaALIQUOTAPISCONFINS: TIBBCDField;
    TEmpresaTRIB_NFSE: TIBStringField;
    TEmpresaCOFINS: TIBBCDField;
    TEmpresaPIS: TIBBCDField;
    TEmpresaVLR_SERVICO: TIBBCDField;
    TLojaGERANFSE: TIBStringField;
    TLojaTITULODUPLICATA: TIBStringField;
    TEmpresaCRT: TSmallintField;
    TLojaMODODEEMISSAONFE: TIBStringField;
    TCCE: TIBQuery;
    UCCE: TIBUpdateSQL;
    DSCCE: TDataSource;
    TCCECOD_CCE: TIntegerField;
    TCCECOD_GERADOR: TIntegerField;
    TCCETIPOGERADOR: TIBStringField;
    TCCEDATA: TDateField;
    TCCETEXTO: TMemoField;
    TCCEXML: TMemoField;
    TCCEXMLRESPOSTA: TMemoField;
    TCCEPROTOCOLONUMERO: TIBStringField;
    TCCENSEQUENCIA: TIntegerField;
    TCCEPROTOCOLODATA: TIBStringField;
    ...
    cdsCstCOD_CST: TIntegerField;
    cdsCstCOD_SIT_TRIB: TStringField;
    cdsCstDESCRICAO: TStringField;
    cdsCstINDICEECF: TStringField;
    cdsCstICMSOP: TStringField;
    cdsCstISENTA: TStringField;
    cdsCstREDUCAO: TStringField;
    cdsCstSUBSTITUICAO: TStringField;
    cdsCstVENDA: TStringField;
    cdsUnidade: TClientDataSet;
    cdsUnidadeCOD_UNIDADE: TIntegerField;
    cdsUnidadeDESC_UNID: TStringField;
    cdsUnidadeSIGLA_UNID: TStringField;
    cdsUnidadeARREDONDAR: TStringField;
    cdsSubGrupo: TClientDataSet;
    cdsSubGrupoCOD_SUBGRUPOPROD: TIntegerField;
    cdsSubGrupoCOD_INTERNO: TStringField;
    cdsSubGrupoDESCRICAO: TStringField;
    cdsSubGrupoTIPO: TStringField;
    cdsGrupo: TClientDataSet;
    cdsGrupoCOD_GRUPOPROD: TIntegerField;
    cdsGrupoDESCRICAO: TStringField;
    cdsGrupoCOD_INTERNO: TStringField;
    ...
    cdsPessoaCOD_CIDADE: TIntegerField;
    cdsPessoaCEP: TStringField;
    cdsPessoaCPFCNPJ: TStringField;
    cdsPessoaDATA_INI: TDateField;
    cdsPessoaDTNASC: TDateField;
    cdsPessoaCOD_REGIAO: TIntegerField;
    cdsPessoaCOD_NATURAL: TIntegerField;
    cdsPessoaTELREL: TStringField;
    cdsPessoaDIAANIVER: TSmallintField;
    cdsPessoaPROXIMIDADE: TStringField;
    cdsPessoaVLRCREDITO: TCurrencyField;
    cdsPessoaCOD_TRANSPORTADORA: TIntegerField;
    cdsPessoaENDNUMERO: TStringField;
    cdsPessoaTEL01: TStringField;
    cdsProduto: TClientDataSet;
    cdsProdutoCOD_PRODUTO: TIntegerField;
    cdsProdutoCOD_INTERNO: TStringField;
    cdsProdutoDESCRICAO: TStringField;
    cdsProdutoAPLICACAO: TStringField;
    cdsProdutoCOD_SUBGRUPOPROD: TIntegerField;
    cdsProdutoCOD_GRUPOPROD: TIntegerField;
    cdsProdutoCOD_CST: TIntegerField;
    cdsProdutoCOD_LOJA: TIntegerField;
    cdsProdutoSUBGRUPOPROD: TStringField;
    cdsProdutoGRUPOPROD: TStringField;
    cdsPessoaF: TClientDataSet;
    cdsPessoaFCOD_PESSOAF: TIntegerField;
    cdsPessoaFCOD_PESSOA: TIntegerField;
    cdsPessoaFRG: TStringField;
    cdsPessoaFDATA_EXPED: TDateField;
    cdsPessoaFORGAO_EXPED: TStringField;
    cdsPessoaFINSC_EST_AGRI: TStringField;
    cdsPessoaFCPFCNPJ: TStringField;
    cdsPessoaJ: TClientDataSet;
    cdsPessoaJCOD_PESSOAJ: TIntegerField;
    cdsPessoaJCOD_PESSOA: TIntegerField;
    cdsPessoaJINSC_EST: TStringField;
    cdsPessoaJRAZAO_SOCIAL: TStringField;
    cdsPessoaJINSC_MUN: TStringField;
    cdsPessoaJCPFCNPJ: TStringField;
    cdsTelefone: TClientDataSet;
    cdsTelefoneCOD_TELEFONE: TIntegerField;
    cdsTelefoneCOD_PESSOA: TIntegerField;
    cdsTelefoneDESCRICAO: TStringField;
    cdsTelefoneCONTATO: TStringField;
    cdsTelefoneNUMERO: TStringField;
    cdsTelefoneCPFCNPJ: TStringField;
    cdsEmail: TClientDataSet;
    cdsEmailCOD_EMAIL: TIntegerField;
    cdsEmailCOD_PESSOA: TIntegerField;
    cdsEmailDESCRICAO: TStringField;
    cdsEmailEMAIL: TStringField;
    cdsEmailCPFCNPJ: TStringField;
    TSecundario: TIBQuery;
    cdsSubProduto: TClientDataSet;
    cdsSubProdutoCOD_SUBPRODUTO: TIntegerField;
    cdsSubProdutoDESCRICAO: TStringField;
    cdsSubProdutoCODBARRA: TStringField;
    cdsSubProdutoCODPRODFABR: TStringField;
    cdsSubProdutoFABRICANTE: TStringField;
    cdsSubProdutoMARCA: TStringField;
    cdsSubProdutoCOD_PRODUTO: TIntegerField;
    cdsSubProdutoCOD_INTERNO: TStringField;
    cdsSubProdutoCOD_UNIDCOMPRA: TIntegerField;
    cdsSubProdutoCOD_UNIDVENDA: TIntegerField;
    cdsSubProdutoCOD_CST: TIntegerField;
    cdsSubProdutoCONTRINT: TStringField;
    cdsSubProdutoCOR: TStringField;
    cdsSubProdutoCLASSIFICACAO: TStringField;
    cdsSubProdutoDESCRICAO2: TStringField;
    cdsSubProdutoCOD_INTERNO_ST: TStringField;
    cdsSubProdutoCOD_SIT_TRIB: TStringField;
    cdsSubProdutoINDICEECF: TStringField;
    cdsSubProdutoNCM: TStringField;
    cdsAtualizaBanco1: TClientDataSet;
    QTabela1: TIBQuery;
    cdsFormaPagamento: TClientDataSet;
    cdsFormaPagamentoATIVADESC: TBooleanField;
    cdsFormaPagamentoCOD_FORMPAG: TIntegerField;
    cdsFormaPagamentoCOD_INTERNO: TStringField;
    cdsFormaPagamentoCOD_LOJA: TIntegerField;
    cdsFormaPagamentoDESCFISC: TStringField;
    cdsFormaPagamentoDESCFORMPAG: TFloatField;
    cdsFormaPagamentoDESCRICAO: TStringField;
    cdsFormaPagamentoINTERVALO: TIntegerField;
    cdsFormaPagamentoJUROAPLIC: TFloatField;
    cdsFormaPagamentoMEDIADIAS: TIntegerField;
    cdsFormaPagamentoPRIMPARCELA: TIntegerField;
    cdsFormaPagamentoQUANTPARCELA: TIntegerField;
    cdsFormaPagamentoTIPO: TStringField;
    cdsEstoque: TClientDataSet;
    cdsEstoqueCOD_ESTOQUE: TIntegerField;
    cdsEstoqueCOD_LOJA: TIntegerField;
    cdsEstoqueCOD_SUBPROD: TIntegerField;
    cdsEstoqueESTFISICO: TFloatField;
    cdsEstoqueCVVPROAT: TFloatField;
    cdsEstoqueCVPPROAT: TFloatField;
    cdsEstoqueCVVPROVAR: TFloatField;
    cdsEstoqueCVPPROVAR: TFloatField;
    cdsEstoqueVENDATAP: TCurrencyField;
    cdsEstoqueVENDATAV: TCurrencyField;
    cdsEstoqueVENDVARP: TCurrencyField;
    cdsEstoqueVENDVARV: TCurrencyField;
    cdsEstoqueVALUNIT: TCurrencyField;
    cdsEstoqueAVVPROAT: TCurrencyField;
    cdsEstoqueAVPPROAT: TCurrencyField;
    cdsEstoqueAVVPROVAR: TCurrencyField;
    cdsEstoqueAVPPROVAR: TCurrencyField;
    cdsEstoqueDTCAD: TDateField;
    cdsEstoqueDESCONTO: TCurrencyField;
    cdsEstoqueMARGEMSEG: TCurrencyField;
    cdsEstoquePERCMARGSEG: TCurrencyField;
    cdsEstoquePRECOOFERTA: TCurrencyField;
    cdsEstoqueDATAOFERTA: TDateField;
    cdsEstoqueVENCIMENTOOFERTA: TDateField;
    cdsEstoqueESTLOJA: TCurrencyField;
    cdsEstoqueVLRUNITCOMP: TCurrencyField;
    cdsEstoqueVLRCOMPSD: TCurrencyField;
    cdsEstoqueCONTRINT: TStringField;
    cdsCliente: TClientDataSet;
    cdsClienteCOD_CLIENTE: TIntegerField;
    cdsClienteCOD_PESSOA: TIntegerField;
    cdsClienteCOD_INTERNO: TStringField;
    cdsClienteDATA_CAD: TDateField;
    cdsClienteLIM_CRED: TFloatField;
    cdsClienteCOD_VENDEDOR: TIntegerField;
    cdsClienteATIVO: TStringField;
    cdsClienteOBS: TStringField;
    cdsClienteSCPC: TStringField;
    cdsClienteDIAVENCIMENTO: TIntegerField;
    cdsClienteOBSFINANCEIRA: TStringField;
    cdsClienteVENDAVISTA: TStringField;
    cdsClienteDIASFREQVENDA: TStringField;
    cdsClienteFREQVENDA: TStringField;
    cdsClienteENDENTRAGA: TStringField;
    cdsClienteCOD_FORMPAG: TIntegerField;
    cdsClienteCPFCNPJ: TStringField;
    cdsPedVenda: TClientDataSet;
    cdsPedVendaCOD_PEDVENDA: TIntegerField;
    cdsPedVendaCOD_CLIENTE: TIntegerField;
    cdsPedVendaDTPEDVEN: TDateField;
    cdsPedVendaDESCONTO: TFloatField;
    cdsPedVendaCOD_USUARIO: TIntegerField;
    cdsPedVendaCOD_FORMPAG: TIntegerField;
    cdsPedVendaVALOR: TCurrencyField;
    cdsPedVendaENTREGA: TDateField;
    cdsPedVendaNOMECLI: TStringField;
    cdsPedVendaOBS: TStringField;
    cdsPedVendaCPFCNPJ: TStringField;
    cdsPedVendaCOD_VENDEDOR: TIntegerField;
    cdsPedVendaSITUACAO: TStringField;
    cdsPedVendaNUMPED: TStringField;
    cdsPedVendaCOBRANCA: TStringField;
    cdsPedVendaEXPORTA: TSmallintField;
    cdsItensPedVenda: TClientDataSet;
    cdsItensPedVendaCOD_ITENSPEDVEN: TIntegerField;
    cdsItensPedVendaCOD_PEDVEN: TIntegerField;
    cdsItensPedVendaCOD_ESTOQUE: TIntegerField;
    cdsItensPedVendaQTDEPROD: TCurrencyField;
    cdsItensPedVendaDESCPRO: TFloatField;
    cdsItensPedVendaCOD_FUNCIONARIO: TIntegerField;
    cdsItensPedVendaVALUNIT: TCurrencyField;
    cdsItensPedVendaVALCUSTO: TCurrencyField;
    cdsItensPedVendaVALORTOTAL: TCurrencyField;
    cdsItensPedVendaVALREP: TCurrencyField;
    cdsItensPedVendaCOEFDIV: TCurrencyField;
    cdsItensPedVendaVALCOMP: TCurrencyField;
    cdsItensPedVendaLUCPER: TCurrencyField;
    cdsItensPedVendaLUCMOE: TCurrencyField;
    cdsItensPedVendaDATA: TDateField;
    cdsItensPedVendaCOMISSAO: TCurrencyField;
    cdsItensPedVendaOPERACAO: TStringField;
    cdsItensPedVendaLUCREL: TCurrencyField;
    cdsItensPedVendaVLRVENDBD: TCurrencyField;
    cdsItensPedVendaCOD_UNIDADE: TIntegerField;
    cdsItensPedVendaDTTROCA: TDateField;
    cdsItensPedVendaCOD_CST: TIntegerField;
    cdsItensPedVendaDESCNF: TCurrencyField;
    cdsItensPedVendaCONTRINT: TStringField;
    LADO_ALEX: TClientDataSet;
    TEmpresaMOBILE: TSmallintField;
    TEmpresaVALORTOTALTRIBUTA: TIBBCDField;
    TLojaBAIXAAUTOMATICACARTAO: TSmallintField;
    TLojaUSAPLACASADICIONAIS: TIBStringField;
    TLojaORDENAORDEM: TIBStringField;
    TLojaVERIFDESCPRODUTO: TIBStringField;
    DsSped: TDataSource;
    TSped: TIBQuery;
    cdsItensOrcamento: TClientDataSet;
    cdsItensOrcamentoCOD_ITPRODORC: TIntegerField;
    cdsItensOrcamentoCOD_ORCAMENTO: TIntegerField;
    cdsItensOrcamentoCOD_ESTOQUE: TIntegerField;
    cdsItensOrcamentoQTD: TIntegerField;
    cdsItensOrcamentoDESCONTO: TCurrencyField;
    cdsItensOrcamentoVLRUNIT: TCurrencyField;
    cdsItensOrcamentoVLRTOTAL: TCurrencyField;
    cdsItensOrcamentoVALCUSTO: TCurrencyField;
    cdsItensOrcamentoCOEFDIV: TCurrencyField;
    cdsItensOrcamentoVALCOMP: TCurrencyField;
    cdsItensOrcamentoLUCMOE: TCurrencyField;
    cdsItensOrcamentoLUCPER: TCurrencyField;
    cdsItensOrcamentoVALREP: TCurrencyField;
    cdsItensOrcamentoLUCREL: TCurrencyField;
    cdsItensOrcamentoCOD_UNIDADE: TIntegerField;
    cdsItensOrcamentoQTDEMB: TCurrencyField;
    cdsItensOrcamentoUNIDEMB: TIntegerField;
    cdsItensOrcamentoQTDNAEMB: TCurrencyField;
    cdsOrcamento: TClientDataSet;
    cdsOrcamentoCOD_ORCAMENTO: TIntegerField;
    cdsOrcamentoCOD_USUARIO: TIntegerField;
    cdsOrcamentoCOD_VENDEDOR: TIntegerField;
    cdsOrcamentoCOD_FORMPAG: TIntegerField;
    cdsOrcamentoCOD_LOJA: TIntegerField;
    cdsOrcamentoCOD_CLIENTE: TIntegerField;
    cdsOrcamentoNOMECLI: TStringField;
    cdsOrcamentoCPFCNPJ: TStringField;
    cdsOrcamentoDTABERT: TDateField;
    cdsOrcamentoHRABERT: TTimeField;
    cdsOrcamentoDTVALIDADE: TDateField;
    cdsOrcamentoNUMORC: TIntegerField;
    cdsOrcamentoOBS: TBlobField;
    cdsOrcamentoTIPO: TStringField;
    cdsOrcamentoDESCSERV: TCurrencyField;
    cdsOrcamentoDESCPROD: TCurrencyField;
    cdsOrcamentoVLRSERV: TCurrencyField;
    cdsOrcamentoVLRPROD: TCurrencyField;
    cdsOrcamentoVLRTOTAL: TCurrencyField;
    cdsOrcamentoVLRDESP: TCurrencyField;
    cdsOrcamentoCOD_RESTEC: TIntegerField;
    cdsOrcamentoVLRRESTEC: TCurrencyField;
    cdsOrcamentoDESCPRODMOE: TCurrencyField;
    cdsOrcamentoDESCRICAO: TStringField;
    cdsOrcamentoCOD_EQUIPAMENTO: TIntegerField;
    cdsOrcamentoCONTATO: TStringField;
    cdsAtualizaBanco2: TClientDataSet;
    TLojaFORCARCARTAO: TIBStringField;
    TLojaNFSEADMINISTRADORA: TIBStringField;
    TLojaTIPOORCAMENTO: TIBStringField;
    TEmpresaNFSE_CODIGOCNAE: TIBStringField;
    TEmpresaNFSE_DESCRICAOCNAE: TIBStringField;
    TEmpresaNFSE_CODTRIBUTACAOMUNICIPAL: TIBStringField;
    TLojaNFSE_LICENSA: TIBStringField;
    TMPDESC500: TIBStringField;
    TLojaINSERIRFATURA: TIBStringField;
    TEmpresaVALORTOTALTRIBUTANFSE: TIBBCDField;
    TLojaCARACTERISTICA_PRODUTO02: TMemoField;
    TLojaCARACTERISTICA_PRODUTO01: TMemoField;
    TLojaATUALIZAESTOQUEPC: TIBStringField;
    TUsuarioMAXREGISTROOS: TIBStringField;
    TCodigoCOD_SETORPRODUCAO: TIntegerField;
    TCodigoCOD_ITEMFICHATECNICA: TIntegerField;
    TCodigoCOD_SETOR: TIntegerField;
    TLojaCAMINHOXML: TIBStringField;
    TLojaEXIBECLASSSERV: TIBStringField;
    TUsuarioEXIBE_EXPEDICAO: TIBStringField;
    TMPDESC2: TIBStringField;
    TLojaALIQVAR: TIBBCDField;
    TLojaALIQATAC: TIBBCDField;
    TLojaTIPOIMP_NFCE: TIBStringField;
    TEmpresaVALOR_MAX_NFCE: TIBBCDField;
    TLojaIDCSC_NFCEPROD: TIBStringField;
    TLojaCSC_NFCEPROD: TIBStringField;
    TLojaIDCSC_NFCEHOMO: TIBStringField;
    TLojaCSC_NFCEHOMO: TIBStringField;
    TLojaUsuGERABONIF: TIBStringField;
    TLojaUsuGERACANC: TIBStringField;
    TLojaEXIBVLRCOMPOS: TIBStringField;
    TLojaUsuCK110: TIBStringField;
    TLojaUsuCK130: TIBStringField;
    TLojaUsuCK140: TIBStringField;
    TLojaUsuCK150: TIBStringField;
    TLojaUsuCK160: TIBStringField;
    TLojaUsuCK170: TIBStringField;
    TLojaUsuCK218: TIBStringField;
    TLojaUsuCK219: TIBStringField;
    TLojaUsuCK223: TIBStringField;
    TLojaUsuCK225: TIBStringField;
    TLojaUsuCK226: TIBStringField;
    TLojaUsuCK229: TIBStringField;
    TLojaUsuCK231: TIBStringField;
    TLojaUsuCK232: TIBStringField;
    TLojaUsuCK233: TIBStringField;
    TLojaUsuCK234: TIBStringField;
    TLojaUsuCK235: TIBStringField;
    TLojaUsuCK236: TIBStringField;
    TLojaUsuCK237: TIBStringField;
    TLojaUsuALTCHECKEXPRESS: TIBStringField;
    TLojaUsuREMOVERCHECKEXPRESS: TIBStringField;
    TLojaUsuCONSULTARCHECKEXPRESS: TIBStringField;
    TLojaEMAIL_EMPRESA: TIBStringField;
    TLojaSENHAEMAIL_EMPRESA: TIBStringField;
    TLojaSERVIDOR_SMTP: TIBStringField;
    TLojaPORTA_EMAIL: TIntegerField;
    TLojaTXTAUX_EMAIL: TIBStringField;
    TUsuarioFILTRAPEDFECHADO: TSmallintField;
    TUsuarioFILTRAPEDDATA01: TIBStringField;
    TUsuarioFILTRAPEDDATA02: TIBStringField;
    DbBloqueio: TIBDatabase;
    TBloqueio: TIBTransaction;
    QBloqueio: TIBQuery;
    DSBloqueio: TDataSource;
    TLojaLOGINSUPORTE: TIBStringField;
    TLojaCFOPINTOUTEMISSAOPROP: TIntegerField;
    TLojaCFOPEXTOUTEMISSAOPROP: TIntegerField;
    TLojaBLOQBTNFISCAL: TIBStringField;
    TLojaCAMINHODOCS: TIBStringField;
    TEmpresaNFCESERIE: TIntegerField;
    TLojaUSARVENDEDOROSMEC: TIBStringField;
    TLojaUSAR4CASASQTD: TIBStringField;
    TLojaRECALCULA_LUCRATIV_PRODUTO: TIBStringField;
    TLojaMAISDEUMCONTROLEINTERNO: TIBStringField;
    TLojaDESABCOPIAPRODUTOS: TIBStringField;
    TEmpresaNFSE_REGIMEMUNICIPAL: TIBStringField;
    TEmpresaFONE: TIBStringField;
    TEmpresaTEL0800: TIBStringField;
    TLojaUsuEDITAVENDEDOROS: TIBStringField;
    TLojaUSARMULTIPLOSVENDEDORESOS: TIBStringField;
    TLojaCOD_CONTAANTECIPACAOCR: TIntegerField;
    TLojaCNPJ_CONTABILIDADE: TIBStringField;
    TLojaIMPSTXMLPRODUTO: TIBStringField;
    TMPDESC4: TIBStringField;
    TMPDESC5: TIBStringField;
    TMPDESC6: TIBStringField;
