...
type
  TDMGEOGRAFIA = class(TDataModule)
    ...
    TEstadoEXTERIOR: TIntegerField;
    TEstadoMVAFORASIMPLES: TIBBCDField;
    TEstadoCODBACEN: TIBStringField;
    TEstadoNOMEPAIS: TIBStringField;
    TCidadeUFEMBARQUE: TIBStringField;
    TCidadeLOCALEMBARQUE: TIBStringField;
    TCidadeSIGLA: TIBStringField;
  private
