object DMMACS: TDMMACS
  ...
  object DataBase: TIBDatabase
    DatabaseName = 'SERVER:C:\MZR\MACS\DBMACS.GDB'
    Params.Strings = (
      'user_name=SYSDBA'
      'password=masterkey'
      'lc_ctype=ISO8859_1'
  ...
  object UPLoja: TIBUpdateSQL
    ...
    InsertSQL.Strings = (
      'insert into LOJA'
        ...
        '   NAOATUALIZAESTOQUEPC, DIASVENC, EMISSAOPROPDENTRO, EMISSAOPRO' +
        'PFORA, '
      
        '   TITULODUPLICATA, GERANFSE, MODODEEMISSAONFE, USAPLACASADICION' +
        'AIS, BAIXAAUTOMATICACARTAO, '
      
        '   ORDENAORDEM, VERIFDESCPRODUTO, FORCARCARTAO, NFSE_LICENSA, TI' +
        'POORCAMENTO, '
      
        '   NFSEADMINISTRADORA, CARACTERISTICA_PRODUTO01, CARACTERISTICA_' +
        'PRODUTO02, '
      
        '   INSERIRFATURA, ATUALIZAESTOQUEPC, EXIBECLASSSERV, CAMINHOXML,' +
        ' ALIQATAC, '
      
        '   ALIQVAR, IDCSC_NFCEPROD, CSC_NFCEPROD, IDCSC_NFCEHOMO, CSC_NF' +
        'CEHOMO, '
      
        '   TIPOIMP_NFCE, EMAIL_EMPRESA, SENHAEMAIL_EMPRESA, SERVIDOR_SMT' +
        'P, PORTA_EMAIL, '
      
        '   TXTAUX_EMAIL, EXIBVLRCOMPOS, CAMINHODOCS, BLOQBTNFISCAL, CFOP' +
        'INTOUTEMISSAOPROP, '
      
        '   CFOPEXTOUTEMISSAOPROP, USARVENDEDOROSMEC, RECALCULA_LUCRATIV_' +
        'PRODUTO, '
      
        '   USAR4CASASQTD, DESABCOPIAPRODUTOS, MAISDEUMCONTROLEINTERNO, C' +
        'NPJ_CONTABILIDADE, '
      
        '   COD_CONTAANTECIPACAOCR, USARMULTIPLOSVENDEDORESOS, IMPSTXMLPR' +
        'ODUTO)'
      'values'
        ...
        '   :MOVCAIXACARTAO, :NAOATUALIZAESTOQUEPC, :DIASVENC, :EMISSAOPR' +
        'OPDENTRO, '
      
        '   :EMISSAOPROPFORA, :TITULODUPLICATA, :GERANFSE, :MODODEEMISSAO' +
        'NFE, :USAPLACASADICIONAIS, '
      
        '   :BAIXAAUTOMATICACARTAO, :ORDENAORDEM, :VERIFDESCPRODUTO, :FOR' +
        'CARCARTAO, '
      
        '   :NFSE_LICENSA, :TIPOORCAMENTO, :NFSEADMINISTRADORA, :CARACTER' +
        'ISTICA_PRODUTO01, '
      
        '   :CARACTERISTICA_PRODUTO02, :INSERIRFATURA, :ATUALIZAESTOQUEPC' +
        ', :EXIBECLASSSERV, '
      
        '   :CAMINHOXML, :ALIQATAC, :ALIQVAR, :IDCSC_NFCEPROD, :CSC_NFCEP' +
        'ROD, :IDCSC_NFCEHOMO, '
      
        '   :CSC_NFCEHOMO, :TIPOIMP_NFCE, :EMAIL_EMPRESA, :SENHAEMAIL_EMP' +
        'RESA, :SERVIDOR_SMTP, '
      
        '   :PORTA_EMAIL, :TXTAUX_EMAIL, :EXIBVLRCOMPOS, :CAMINHODOCS, :B' +
        'LOQBTNFISCAL, '
      
        '   :CFOPINTOUTEMISSAOPROP, :CFOPEXTOUTEMISSAOPROP, :USARVENDEDOR' +
        'OSMEC, '
      
        '   :RECALCULA_LUCRATIV_PRODUTO, :USAR4CASASQTD, :DESABCOPIAPRODU' +
        'TOS, :MAISDEUMCONTROLEINTERNO, '
      
        '   :CNPJ_CONTABILIDADE, :COD_CONTAANTECIPACAOCR, :USARMULTIPLOSV' +
        'ENDEDORESOS, '
      '   :IMPSTXMLPRODUTO)')
    DeleteSQL.Strings = (
      'delete from LOJA'
  ...
  object UEMPRESA: TIBUpdateSQL
    ...
    InsertSQL.Strings = (
      ...
      'WEB_PAGE, '
        ...
        ' '
      'CVPPROVAR, '
      '   AVVPROAT, AVPPROAT, AVVPROVAR, AVPPROVAR, IMPFED, IMPEST, '
      'COD_MOEDA, '
      '   ZEROCODPESSOA, NCASASZEROPES, PROXPEDVEND, PROXPEDCOMP, '
      'FONE, NUMERO, '
      
        '   CONTATO, PROX_OS, PROXORC, JUROSBOLET, CREDITAIPI, CALCULAIPI' +
        ', '
      'TIPOEMPRESA, '
      '   PROXLICITA, TEL0800, CONTICMS, TIPOEMPRESANF, NFEPROXLOTE, '
      'NFESERIE, '
      '   ALIQICMS, INDUSTRIA, NCI, DTCONFATUAL, NAOCALCST, EMEXPORTA, '
      'PROXNUMSCAN, '
      '   NFESERIESCAN, COD_EXPORT, APLICAPISCONFINSSAIDA, '
      'ALIQUOTAPISCONFINS, '
      '   TRIB_NFSE, COFINS, PIS, VLR_SERVICO, CRT, MOBILE, '
      'VALORTOTALTRIBUTA, '
      '   NFSE_CODTRIBUTACAOMUNICIPAL, NFSE_DESCRICAOCNAE, '
      'NFSE_CODIGOCNAE, NFSE_REGIMEMUNICIPAL, '
      '   VALORTOTALTRIBUTANFSE, VALOR_MAX_NFCE, NFCESERIE)'
      'values'
      
        '  (:COD_EMPRESA, :NUM_FILIAL, :FANTASIA, :RAZAO_SOCIAL, :COD_CID' +
        'ADE, '
      ':TIPO, '
      '   :ENDERECO, :BAIRRO, :CEP, :CX_POSTAL, :CNPJ, :INSC_EST, '
      ':DATA_FUNDACAO, '
      
        '   :INSC_MUN, :WEB_PAGE, :PROX_NF, :CAD_SRF, :ICMS, :ISSQN, :CVV' +
        'PROAT, '
      '   :CVPPROAT, :CVVPROVAR, :CVPPROVAR, :AVVPROAT, :AVPPROAT, '
      ':AVVPROVAR, '
      '   :AVPPROVAR, :IMPFED, :IMPEST, :COD_MOEDA, :ZEROCODPESSOA, '
      ':NCASASZEROPES, '
      ...
      ':TEL0800, '
        ...
        ', '
      ':INDUSTRIA, '
      '   :NCI, :DTCONFATUAL, :NAOCALCST, :EMEXPORTA, :PROXNUMSCAN, '
      ':NFESERIESCAN, '
      '   :COD_EXPORT, :APLICAPISCONFINSSAIDA, :ALIQUOTAPISCONFINS, '
      ':TRIB_NFSE, '
