inherited FServico: TFServico
  ...
  inherited PCadastro: TPanel [0]
    ...
    inherited Panel4: TPanel [1]
      ...
      object cbRecorrencia: TCheckBox
        Left = 599
        Top = 26
        Width = 161
        Height = 17
  ...
  inherited PConsulta: TPanel [1]
    ...
    object btnAtualizaValores: TBitBtn
      Left = 664
      Top = 208
      Width = 105
      Height = 25
      ...
      TabOrder = 6
      OnClick = btnAtualizaValoresClick
    end
    object pAtualizaValores: TPanel
      Left = 208
      Top = 128
      Width = 369
      Height = 225
      ...
      object Label6: TLabel
        ...
        Width = 178
        Height = 8
        Caption = 'Duplo clique em "Novo Valor" para atualiza-lo'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -7
        Font.Name = 'verdana'
      ...
      object rbtnCompra: TRadioButton
        Left = 64
        Top = 56
        Width = 120
        Height = 17
      ...
      object edAliqAtualiza: TFloatEdit
        Left = 86
        Top = 26
        Width = 121
        Height = 24
