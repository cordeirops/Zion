object DMENTRADA: TDMENTRADA
  ...
  object TPedC: TIBQuery
    ...
    object TPedCCHAVENFEXML: TIBStringField
      FieldName = 'CHAVENFEXML'
      Origin = 'PEDCOMPRA.CHAVENFEXML'
      Size = 50
    end
    object TPedCVLRSEGURO: TIBBCDField
      FieldName = 'VLRSEGURO'
      Origin = 'PEDCOMPRA.VLRSEGURO'
      Precision = 18
      Size = 2
    end
    object TPedCCOD_PRODMANUTENCAO: TIntegerField
      FieldName = 'COD_PRODMANUTENCAO'
      Origin = 'PEDCOMPRA.COD_PRODMANUTENCAO'
    end
    object TPedCDESCRICAO_PRODMANUTENCAO: TIBStringField
      FieldName = 'DESCRICAO_PRODMANUTENCAO'
      Origin = 'PEDCOMPRA.DESCRICAO_PRODMANUTENCAO'
      Size = 100
    end
    object TPedCTIPO: TIBStringField
      FieldName = 'TIPO'
      Origin = 'PEDCOMPRA.TIPO'
      Size = 10
    end
    object TPedCNUMFISCAL_DEVOLVIDA: TIBStringField
      FieldName = 'NUMFISCAL_DEVOLVIDA'
      Size = 10
    end
    object TPedCCOD_PK_DEV: TIntegerField
      FieldName = 'COD_PK_DEV'
      Origin = 'PEDCOMPRA.COD_PK_DEV'
    end
    object TPedCNUMFISCAL_PV_OS: TIBStringField
      FieldName = 'NUMFISCAL_PV_OS'
      Origin = 'PEDCOMPRA.NUMFISCAL_PV_OS'
      Size = 10
    end
  end
  object TItemPC: TIBQuery
    ...
    object TItemPCVALORTOTALTRIBUTAESTADUAL: TIBBCDField
      FieldName = 'VALORTOTALTRIBUTAESTADUAL'
      Origin = 'ITENSPEDC.VALORTOTALTRIBUTAESTADUAL'
      Precision = 18
      Size = 2
    end
    object TItemPCALIQ_DEVOLVIDO: TIBBCDField
      FieldName = 'ALIQ_DEVOLVIDO'
      Origin = 'ITENSPEDC.ALIQ_DEVOLVIDO'
      Precision = 18
      Size = 2
    end
    object TItemPCIT_DEV: TIBStringField
      FieldName = 'IT_DEV'
      Origin = 'ITENSPEDC.IT_DEV'
      FixedChar = True
      Size = 5
    end
    object TItemPCVALORFRETE: TIBBCDField
      FieldName = 'VALORFRETE'
      Origin = 'ITENSPEDC.VALORFRETE'
      Precision = 18
      Size = 2
    end
    object TItemPCVALORDESP: TIBBCDField
      FieldName = 'VALORDESP'
      Origin = 'ITENSPEDC.VALORDESP'
      Precision = 18
      Size = 2
    end
    object TItemPCBASECALCII: TIBBCDField
      FieldName = 'BASECALCII'
      Origin = 'ITENSPEDC.BASECALCII'
      Precision = 18
      Size = 2
    end
    object TItemPCOUTDESPII: TIBBCDField
      FieldName = 'OUTDESPII'
      Origin = 'ITENSPEDC.OUTDESPII'
      Precision = 18
      Size = 2
    end
    object TItemPCVALORII: TIBBCDField
      FieldName = 'VALORII'
      Origin = 'ITENSPEDC.VALORII'
      Precision = 18
      Size = 2
    end
    object TItemPCVALORIOF: TIBBCDField
      FieldName = 'VALORIOF'
      Origin = 'ITENSPEDC.VALORIOF'
      Precision = 18
      Size = 2
    end
    object TItemPCQTD4CASAS: TIBStringField
      FieldName = 'QTD4CASAS'
      Origin = 'ITENSPEDC.QTD4CASAS'
      Size = 15
    end
    object TItemPCNUMPEDCOMPRANFE: TIBStringField
      FieldName = 'NUMPEDCOMPRANFE'
      Origin = 'ITENSPEDC.NUMPEDCOMPRANFE'
      Size = 15
    end
    object TItemPCNUMITEMPEDCOMPRANFE: TIBStringField
      FieldName = 'NUMITEMPEDCOMPRANFE'
      Origin = 'ITENSPEDC.NUMITEMPEDCOMPRANFE'
      Size = 6
    end
    object TItemPCBASEICMSUFDEST: TIBBCDField
      FieldName = 'BASEICMSUFDEST'
      Origin = 'ITENSPEDC.BASEICMSUFDEST'
      Precision = 18
      Size = 2
    end
  end
  object TLancEnt: TIBQuery
    ...
    object TLancEntQTD4CASAS: TIBStringField
      FieldName = 'QTD4CASAS'
      Origin = 'LANCENT.QTD4CASAS'
      Size = 15
    end
  end
  object UPedC: TIBUpdateSQL
    ...
    ModifySQL.Strings = (
      ...
      '  VLROUTROS = :VLROUTROS,'
      '  VLRSEGURO = :VLRSEGURO,'
      '  CHAVENFEXML = :CHAVENFEXML,'
      '  COD_PRODMANUTENCAO = :COD_PRODMANUTENCAO,'
      '  DESCRICAO_PRODMANUTENCAO = :DESCRICAO_PRODMANUTENCAO,'
      '  TIPO = :TIPO,'
      '  NUMFISCAL_DEVOLVIDA = :NUMFISCAL_DEVOLVIDA,'
      '  COD_PK_DEV = :COD_PK_DEV,'
      '  NUMFISCAL_PV_OS = :NUMFISCAL_PV_OS'
      'where'
    ...
    InsertSQL.Strings = (
      ...
      'VLRPCOMIS, PERCOMIS, '
        ...
        ', '
      'FISCO, '
      '   NUMFISCAL, DESCMOE, COBRANCA, EXPORT, MARK, FATURADO, '
      'VLRFRETE, EMISSAOPROPRIA, '
      
        '   VLRICMSSUBSTITUICAO, VLRIPI, VLROUTROS, VLRSEGURO, CHAVENFEXM' +
        'L, '
      'COD_PRODMANUTENCAO, '
      '   DESCRICAO_PRODMANUTENCAO, TIPO, NUMFISCAL_DEVOLVIDA, '
      'COD_PK_DEV, NUMFISCAL_PV_OS)'
      'values'
      '  (:COD_PEDCOMP, :COD_FORNEC, :VENDEDOR, :COD_USUARIO, :VALOR, '
      ':COD_FORMPAG, '
      '   :DTPEDCOMP, :DESCONTO, :PRAZOENTR, :OBS, :SITUACAO, :NUMPED, '
      ...
      ':COD_DEVOLUCAO, '
        ...
        'ARK, '
      ':FATURADO, '
      '   :VLRFRETE, :EMISSAOPROPRIA, :VLRICMSSUBSTITUICAO, :VLRIPI, '
      ':VLROUTROS, '
      '   :VLRSEGURO, :CHAVENFEXML, :COD_PRODMANUTENCAO, '
      ':DESCRICAO_PRODMANUTENCAO, '
      '   :TIPO, :NUMFISCAL_DEVOLVIDA, :COD_PK_DEV, :NUMFISCAL_PV_OS)')
    DeleteSQL.Strings = (
  ...
  object UItemPC: TIBUpdateSQL
    ...
    InsertSQL.Strings = (
      ...
      '  (COD_ITENSPEDC, COD_PEDCOMPRA, COD_ESTOQUE, QTDEPROD, '
      'VALUNIT, VALORTOTAL, '
      ...
      'QTDEST, '
      '   COD_DEVOLUCAO, CONTREMESSA, QTDEEXP, COD_UNIDADE, COD_CST, '
      'CFOP, DESCNF, '
      '   OBS, AGRUP, QTDBRUTA, QTDDESCARTE, MOTIVODESCARTE, CONSUMO, '
      'VALORTOTALTRIBUTA, '
      '   ALIQUOTATOTALTRIBUTA, VALORTOTALTRIBUTAESTADUAL, IT_DEV, '
      'ALIQ_DEVOLVIDO, '
      
        '   VALORDESP, VALORFRETE, BASECALCII, OUTDESPII, VALORII, VALORI' +
        'OF, '
      'NUMPEDCOMPRANFE, '
      ...
      ':REDUCBASEICMS, '
        ...
        ', '
      ':COD_CST, '
      '   :CFOP, :DESCNF, :OBS, :AGRUP, :QTDBRUTA, :QTDDESCARTE, '
      ':MOTIVODESCARTE, '
      '   :CONSUMO, :VALORTOTALTRIBUTA, :ALIQUOTATOTALTRIBUTA, '
      ':VALORTOTALTRIBUTAESTADUAL, '
      
        '   :IT_DEV, :ALIQ_DEVOLVIDO, :VALORDESP, :VALORFRETE, :BASECALCI' +
        'I, '
      ':OUTDESPII, '
      '   :VALORII, :VALORIOF, :NUMPEDCOMPRANFE, :NUMITEMPEDCOMPRANFE, '
      ':QTD4CASAS, '
      '   :BASEICMSUFDEST)')
    DeleteSQL.Strings = (
  ...
  object ULancEnt: TIBUpdateSQL
    ...
    InsertSQL.Strings = (
      'insert into LANCENT'
        ...
        'VO, DT_LANCAMENTO, '
      '   DT_ESTOQUE, QUANTIDADE, QTDANT, COD_LOTE, QTD4CASAS)'
      'values'
  ...
  object WPedc: TIBQuery
    ...
    object WPedcNUMFISCAL_DEV: TIBStringField
      FieldName = 'NUMFISCAL_DEV'
      Origin = 'VWPEDC.NUMFISCAL_DEV'
      Size = 10
    end
    object WPedcRAZAOSOCIAL: TIBStringField
      FieldName = 'RAZAOSOCIAL'
      Origin = 'VWPEDC.RAZAOSOCIAL'
      Size = 100
    end
  end
  ...
  object WLancEnt: TIBQuery
    ...
    object WLancEntPRODUTO: TIBStringField
      FieldName = 'PRODUTO'
      Origin = 'VWLANCENT.PRODUTO'
      Size = 120
    end
    object WLancEntQTD4CASAS: TIBStringField
      FieldName = 'QTD4CASAS'
      Origin = 'VWLANCENT.QTD4CASAS'
      Size = 15
    end
  end
  ...
  object TFiscPC: TIBQuery
    ...
    object TFiscPCVALORTOTALTRIBUTAESTADUAL: TIBBCDField
      FieldName = 'VALORTOTALTRIBUTAESTADUAL'
      Origin = 'DOCFIS.VALORTOTALTRIBUTAESTADUAL'
      Precision = 18
      Size = 2
    end
    object TFiscPCNUMERODIIMP: TIBStringField
      FieldName = 'NUMERODIIMP'
      Origin = 'DOCFIS.NUMERODIIMP'
      Size = 10
    end
    object TFiscPCDATADIIMP: TDateTimeField
      FieldName = 'DATADIIMP'
      Origin = 'DOCFIS.DATADIIMP'
    end
    object TFiscPCDATADESEMBARQUEIMP: TDateTimeField
      FieldName = 'DATADESEMBARQUEIMP'
      Origin = 'DOCFIS.DATADESEMBARQUEIMP'
    end
    object TFiscPCTIPOTRANSPORTEIMP: TIntegerField
      FieldName = 'TIPOTRANSPORTEIMP'
      Origin = 'DOCFIS.TIPOTRANSPORTEIMP'
    end
    object TFiscPCVALORAFRMMIMP: TIBBCDField
      FieldName = 'VALORAFRMMIMP'
      Origin = 'DOCFIS.VALORAFRMMIMP'
      Precision = 18
      Size = 2
    end
    object TFiscPCFORMAIMPORTACAOIMP: TIntegerField
      FieldName = 'FORMAIMPORTACAOIMP'
      Origin = 'DOCFIS.FORMAIMPORTACAOIMP'
    end
    object TFiscPCCNPJADQTENCIMP: TIBStringField
      FieldName = 'CNPJADQTENCIMP'
      Origin = 'DOCFIS.CNPJADQTENCIMP'
      Size = 14
    end
    object TFiscPCUFADQTENCIMP: TIBStringField
      FieldName = 'UFADQTENCIMP'
      Origin = 'DOCFIS.UFADQTENCIMP'
      Size = 2
    end
    object TFiscPCCODEXPORTADORIMP: TIBStringField
      FieldName = 'CODEXPORTADORIMP'
      Origin = 'DOCFIS.CODEXPORTADORIMP'
      Size = 60
    end
    object TFiscPCURL_QRCODE: TIBStringField
      FieldName = 'URL_QRCODE'
      Origin = 'DOCFIS.URL_QRCODE'
      Size = 500
    end
    object TFiscPCCONTINGENCIA: TIBStringField
      FieldName = 'CONTINGENCIA'
      Origin = 'DOCFIS.CONTINGENCIA'
      FixedChar = True
      Size = 1
    end
  end
  object UFiscPC: TIBUpdateSQL
    ...
    ModifySQL.Strings = (
      ...
      '  VALORTOTALTRIBUTA = :VALORTOTALTRIBUTA,'
      '  VALORTOTALTRIBUTAESTADUAL = :VALORTOTALTRIBUTAESTADUAL,'
      '  NUMERODIIMP = :NUMERODIIMP,'
      '  DATADIIMP = :DATADIIMP,'
      '  DATADESEMBARQUEIMP = :DATADESEMBARQUEIMP,'
      '  TIPOTRANSPORTEIMP = :TIPOTRANSPORTEIMP,'
      '  VALORAFRMMIMP = :VALORAFRMMIMP,'
      '  FORMAIMPORTACAOIMP = :FORMAIMPORTACAOIMP,'
      '  CNPJADQTENCIMP = :CNPJADQTENCIMP,'
      '  UFADQTENCIMP = :UFADQTENCIMP,'
      '  CODEXPORTADORIMP = :CODEXPORTADORIMP,'
    ...
    InsertSQL.Strings = (
      ...
      'VLRTOTDOCNF, '
      '   VLROUTROS, FRETECOMP, VLREMB, TIPOGERADOR, NUMCONHEC, '
      'VLROUTRASDESP, '
      
        '   VLRISENTOICMS, MODELONF, EMPEMIT, NFESERIE, NFECHAVE, NFELOTE' +
        ', '
      'NFERECIBO, '
      '   NFEERRO, NFEPROTOCOLO, NFESTATUS, NFEAMBIENTE, NFEXML, '
      'NFETPEMIS, XMLAUTORIZACAO, '
      '   COD_CFOP1, COD_CFOP2, COD_PERIODOFISCAL, VLRDESCONTO, '
      'EMISSAOPROPRIA, '
      
        '   NUMDOCFISCINT, NFEXMLDIST, NFEXMLCANCEL, ALIQUOTATOTALTRIBUTA' +
        ', '
      'VALORTOTALTRIBUTA, '
      '   VALORTOTALTRIBUTAESTADUAL, NUMERODIIMP, DATADIIMP, '
      'DATADESEMBARQUEIMP, '
      '   TIPOTRANSPORTEIMP, VALORAFRMMIMP, FORMAIMPORTACAOIMP, '
      'CNPJADQTENCIMP, '
      '   UFADQTENCIMP, CODEXPORTADORIMP, URL_QRCODE, CONTINGENCIA)'
      'values'
      ...
      ':TIPOGERADOR, '
      '   :NUMCONHEC, :VLROUTRASDESP, :VLRISENTOICMS, :MODELONF, '
      ':EMPEMIT, :NFESERIE, '
      '   :NFECHAVE, :NFELOTE, :NFERECIBO, :NFEERRO, :NFEPROTOCOLO, '
      ':NFESTATUS, '
      
        '   :NFEAMBIENTE, :NFEXML, :NFETPEMIS, :XMLAUTORIZACAO, :COD_CFOP' +
        '1, '
      ':COD_CFOP2, '
      '   :COD_PERIODOFISCAL, :VLRDESCONTO, :EMISSAOPROPRIA, '
      ':NUMDOCFISCINT, :NFEXMLDIST, '
      '   :NFEXMLCANCEL, :ALIQUOTATOTALTRIBUTA, :VALORTOTALTRIBUTA, '
      ':VALORTOTALTRIBUTAESTADUAL, '
      '   :NUMERODIIMP, :DATADIIMP, :DATADESEMBARQUEIMP, '
      ':TIPOTRANSPORTEIMP, :VALORAFRMMIMP, '
      '   :FORMAIMPORTACAOIMP, :CNPJADQTENCIMP, :UFADQTENCIMP, '
      ':CODEXPORTADORIMP, '
  ...
  object TImpNfeTMP: TIBQuery
    ...
    object TImpNfeTMPCFOP: TIBStringField
      FieldName = 'CFOP'
      Origin = 'IMPNFETMP.CFOP'
      Size = 4
    end
    object TImpNfeTMPQTDEMB: TIBBCDField
      FieldName = 'QTDEMB'
      Origin = 'IMPNFETMP.QTDEMB'
      Precision = 18
      Size = 3
    end
    object TImpNfeTMPQUANTIDADE: TIBBCDField
      FieldName = 'QUANTIDADE'
      Origin = 'IMPNFETMP.QUANTIDADE'
      Precision = 18
      Size = 2
    end
    object TImpNfeTMPVALORVENDAAT: TIBBCDField
      FieldName = 'VALORVENDAAT'
      Origin = 'IMPNFETMP.VALORVENDAAT'
      Precision = 18
      Size = 2
    end
    object TImpNfeTMPMARCA: TIBStringField
      FieldName = 'MARCA'
      Origin = 'IMPNFETMP.MARCA'
      Size = 40
    end
    object TImpNfeTMPLUCRATIVIDADE: TIBBCDField
      FieldName = 'LUCRATIVIDADE'
      Origin = 'IMPNFETMP.LUCRATIVIDADE'
      Precision = 18
      Size = 2
    end
    object TImpNfeTMPCSTVENDA: TIBStringField
      FieldName = 'CSTVENDA'
      Origin = 'IMPNFETMP.CSTVENDA'
      Size = 4
    end
    object TImpNfeTMPVALORFRETE: TIBBCDField
      FieldName = 'VALORFRETE'
      Origin = 'IMPNFETMP.VALORFRETE'
      Precision = 18
      Size = 2
    end
    object TImpNfeTMPALIQFRETE: TIBBCDField
      FieldName = 'ALIQFRETE'
      Origin = 'IMPNFETMP.ALIQFRETE'
      Precision = 9
      Size = 2
    end
    object TImpNfeTMPVALORREP: TIBBCDField
      FieldName = 'VALORREP'
      Origin = 'IMPNFETMP.VALORREP'
      Precision = 18
      Size = 2
    end
    object TImpNfeTMPVALORPIS: TIBBCDField
      FieldName = 'VALORPIS'
      Origin = 'IMPNFETMP.VALORPIS'
      Precision = 18
      Size = 2
    end
    object TImpNfeTMPVALORCOFINS: TIBBCDField
      FieldName = 'VALORCOFINS'
      Origin = 'IMPNFETMP.VALORCOFINS'
      Precision = 18
      Size = 2
    end
    object TImpNfeTMPVALORSEGURO: TIBBCDField
      FieldName = 'VALORSEGURO'
      Origin = 'IMPNFETMP.VALORSEGURO'
      Precision = 18
      Size = 2
    end
    object TImpNfeTMPDESCPRODVINCULADO: TIBStringField
      FieldName = 'DESCPRODVINCULADO'
      Origin = 'IMPNFETMP.DESCPRODVINCULADO'
      Size = 150
    end
    object TImpNfeTMPVALOROUTROS: TIBBCDField
      FieldName = 'VALOROUTROS'
      Origin = 'IMPNFETMP.VALOROUTROS'
      Precision = 18
      Size = 2
    end
    object TImpNfeTMPNITEM: TIntegerField
      FieldName = 'NITEM'
      Origin = 'IMPNFETMP.NITEM'
    end
    object TImpNfeTMPCUSTONFE: TIBBCDField
      FieldName = 'CUSTONFE'
      Origin = 'IMPNFETMP.CUSTONFE'
      Precision = 18
      Size = 2
    end
    object TImpNfeTMPVALORDESCONTO: TIBBCDField
      FieldName = 'VALORDESCONTO'
      Origin = 'IMPNFETMP.VALORDESCONTO'
      Precision = 18
      Size = 2
    end
    object TImpNfeTMPALIQST: TIBBCDField
      FieldName = 'ALIQST'
      Origin = 'IMPNFETMP.ALIQST'
      Precision = 9
      Size = 4
    end
    object TImpNfeTMPALIQFCP: TIBBCDField
      FieldName = 'ALIQFCP'
      Origin = 'IMPNFETMP.ALIQFCP'
      Precision = 9
      Size = 4
    end
  end
  object UImpNfeTMP: TIBUpdateSQL
    ...
    ModifySQL.Strings = (
      ...
      '  CFOP = :CFOP,'
      '  QTDEMB = :QTDEMB,'
      '  DESCPRODVINCULADO = :DESCPRODVINCULADO,'
      '  CSTVENDA = :CSTVENDA,'
      '  LUCRATIVIDADE = :LUCRATIVIDADE,'
      '  MARCA = :MARCA,'
      '  VALORVENDAAT = :VALORVENDAAT,'
      '  VALORPIS = :VALORPIS,'
    ...
    InsertSQL.Strings = (
      ...
      'VALORTOTAL, '
        ...
        'T, '
      'ICMSSUBST, '
      '   IPI, VALORIPI, CODPRODUTO, VALORVENDA, CST, CODBARRA, CFOP, '
      'QTDEMB, '
      '   DESCPRODVINCULADO, CSTVENDA, LUCRATIVIDADE, MARCA, '
      'VALORVENDAAT, VALORPIS, '
      '   VALORCOFINS, VALORSEGURO, VALOROUTROS, VALORREP, VALORFRETE, '
      'ALIQFRETE, '
      '   CUSTONFE, NITEM, VALORDESCONTO, ALIQST, ALIQFCP)'
      'values'
      '  (:CODPRODFORN, :DESCPROD, :NCM, :TIPOUNIDADE, :QUANTIDADE, '
      ':VALORUN, '
      ...
      ':STATUS, '
        ...
        'ENDA, '
      ':CST, '
      '   :CODBARRA, :CFOP, :QTDEMB, :DESCPRODVINCULADO, :CSTVENDA, '
      ':LUCRATIVIDADE, '
      
        '   :MARCA, :VALORVENDAAT, :VALORPIS, :VALORCOFINS, :VALORSEGURO,' +
        ' '
      ':VALOROUTROS, '
      '   :VALORREP, :VALORFRETE, :ALIQFRETE, :CUSTONFE, :NITEM, '
      ':VALORDESCONTO, '
      '   :ALIQST, :ALIQFCP)')
    DeleteSQL.Strings = (
  ...
  object DAdicaoImp: TDataSource
    DataSet = TAdicaoImp
    Left = 127
    Top = 328
  end
  object UAdicaoImp: TIBUpdateSQL
    RefreshSQL.Strings = (
      'Select '
      '  COD_ADICAO,'
      '  NUMADICAO,'
      ...
      '  NUMDRAWBACK,'
      '  COD_PEDIDO'
      'from ADICAOIMPORTACAO '
      'where'
      '  COD_ADICAO = :COD_ADICAO')
    ModifySQL.Strings = (
      'update ADICAOIMPORTACAO'
      'set'
      '  COD_ADICAO = :COD_ADICAO,'
      '  NUMADICAO = :NUMADICAO,'
      '  CODIGOFABRICANTE = :CODIGOFABRICANTE,'
      '  DESCONTOADICAO = :DESCONTOADICAO,'
      '  NUMDRAWBACK = :NUMDRAWBACK,'
      '  COD_PEDIDO = :COD_PEDIDO'
      'where'
      '  COD_ADICAO = :OLD_COD_ADICAO')
    InsertSQL.Strings = (
      'insert into ADICAOIMPORTACAO'
      '  (COD_ADICAO, NUMADICAO, CODIGOFABRICANTE, DESCONTOADICAO, '
      'NUMDRAWBACK, '
      '   COD_PEDIDO)'
      'values'
      '  (:COD_ADICAO, :NUMADICAO, :CODIGOFABRICANTE, :DESCONTOADICAO, '
      ...
      '   :COD_PEDIDO)')
    DeleteSQL.Strings = (
      'delete from ADICAOIMPORTACAO'
      'where'
      '  COD_ADICAO = :OLD_COD_ADICAO')
    Left = 127
    Top = 280
  end
  object TAdicaoImp: TIBQuery
    Database = IBDB
    Transaction = IBT
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      'select  first 1 * from ADICAOIMPORTACAO')
    UpdateObject = UAdicaoImp
    Left = 127
    Top = 232
    object TAdicaoImpCOD_ADICAO: TIntegerField
      FieldName = 'COD_ADICAO'
      Origin = 'ADICAOIMPORTACAO.COD_ADICAO'
      Required = True
    end
    object TAdicaoImpNUMADICAO: TIBStringField
      FieldName = 'NUMADICAO'
      Origin = 'ADICAOIMPORTACAO.NUMADICAO'
      Size = 3
    end
    object TAdicaoImpCODIGOFABRICANTE: TIBStringField
      FieldName = 'CODIGOFABRICANTE'
      Origin = 'ADICAOIMPORTACAO.CODIGOFABRICANTE'
      Size = 60
    end
    object TAdicaoImpDESCONTOADICAO: TIBBCDField
      FieldName = 'DESCONTOADICAO'
      Origin = 'ADICAOIMPORTACAO.DESCONTOADICAO'
      Precision = 18
      Size = 2
    end
    object TAdicaoImpNUMDRAWBACK: TIBStringField
      FieldName = 'NUMDRAWBACK'
      Origin = 'ADICAOIMPORTACAO.NUMDRAWBACK'
      Size = 11
    end
    object TAdicaoImpCOD_PEDIDO: TIntegerField
      FieldName = 'COD_PEDIDO'
      Origin = 'ADICAOIMPORTACAO.COD_PEDIDO'
    end
  end
  object TCustoEstoqueEmpresa: TIBQuery
    Database = IBDB
    Transaction = IBT
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      'select  first 1 * from CUSTOESTOQUEEMPRESA')
    UpdateObject = UCustoEstoqueEmpresa
    Left = 223
    Top = 232
    object TCustoEstoqueEmpresaCOD_CUSTOESTOQUEEMPRESA: TIntegerField
      FieldName = 'COD_CUSTOESTOQUEEMPRESA'
      Origin = 'CUSTOESTOQUEEMPRESA.COD_CUSTOESTOQUEEMPRESA'
      Required = True
    end
    object TCustoEstoqueEmpresaCOD_ESTOQUE: TIntegerField
      FieldName = 'COD_ESTOQUE'
      Origin = 'CUSTOESTOQUEEMPRESA.COD_ESTOQUE'
    end
    object TCustoEstoqueEmpresaVALORUNITARIOCUSTO: TIBBCDField
      FieldName = 'VALORUNITARIOCUSTO'
      Origin = 'CUSTOESTOQUEEMPRESA.VALORUNITARIOCUSTO'
      Precision = 18
      Size = 2
    end
    object TCustoEstoqueEmpresaQUANTIDADEDISPONIVELVENDA: TIBBCDField
      FieldName = 'QUANTIDADEDISPONIVELVENDA'
      Origin = 'CUSTOESTOQUEEMPRESA.QUANTIDADEDISPONIVELVENDA'
      Precision = 18
      Size = 3
    end
    object TCustoEstoqueEmpresaDATA: TDateField
      FieldName = 'DATA'
      Origin = 'CUSTOESTOQUEEMPRESA.DATA'
    end
    object TCustoEstoqueEmpresaATIVO: TIntegerField
      FieldName = 'ATIVO'
      Origin = 'CUSTOESTOQUEEMPRESA.ATIVO'
    end
    object TCustoEstoqueEmpresaCOD_ITEM: TIntegerField
      FieldName = 'COD_ITEM'
      Origin = 'CUSTOESTOQUEEMPRESA.COD_ITEM'
    end
    object TCustoEstoqueEmpresaTIPOGERADOR: TIBStringField
      FieldName = 'TIPOGERADOR'
      Origin = 'CUSTOESTOQUEEMPRESA.TIPOGERADOR'
      Size = 15
    end
  end
  object UCustoEstoqueEmpresa: TIBUpdateSQL
    RefreshSQL.Strings = (
      'Select '
      ...
      '  COD_ITEM,'
      '  TIPOGERADOR'
      'from CUSTOESTOQUEEMPRESA '
      'where'
      '  COD_CUSTOESTOQUEEMPRESA = :COD_CUSTOESTOQUEEMPRESA')
    ModifySQL.Strings = (
      'update CUSTOESTOQUEEMPRESA'
      'set'
      '  COD_CUSTOESTOQUEEMPRESA = :COD_CUSTOESTOQUEEMPRESA,'
      '  COD_ESTOQUE = :COD_ESTOQUE,'
      '  VALORUNITARIOCUSTO = :VALORUNITARIOCUSTO,'
      '  QUANTIDADEDISPONIVELVENDA = :QUANTIDADEDISPONIVELVENDA,'
      '  DATA = :DATA,'
      '  ATIVO = :ATIVO,'
      '  COD_ITEM = :COD_ITEM,'
      '  TIPOGERADOR = :TIPOGERADOR'
      'where'
      '  COD_CUSTOESTOQUEEMPRESA = :OLD_COD_CUSTOESTOQUEEMPRESA')
    InsertSQL.Strings = (
      'insert into CUSTOESTOQUEEMPRESA'
      '  (COD_CUSTOESTOQUEEMPRESA, COD_ESTOQUE, VALORUNITARIOCUSTO, '
      'QUANTIDADEDISPONIVELVENDA, '
      '   DATA, ATIVO, COD_ITEM, TIPOGERADOR)'
      'values'
      '  (:COD_CUSTOESTOQUEEMPRESA, :COD_ESTOQUE, :VALORUNITARIOCUSTO, '
      ':QUANTIDADEDISPONIVELVENDA, '
      '   :DATA, :ATIVO, :COD_ITEM, :TIPOGERADOR)')
    DeleteSQL.Strings = (
      'delete from CUSTOESTOQUEEMPRESA'
      'where'
      '  COD_CUSTOESTOQUEEMPRESA = :OLD_COD_CUSTOESTOQUEEMPRESA')
    Left = 223
    Top = 280
  end
  object DSTCustoEstoqueEmpresa: TDataSource
    DataSet = TCustoEstoqueEmpresa
    Left = 223
    Top = 328
  end
  object TCustoNFeListagem: TIBQuery
    Tag = 5
    Database = IBDB
    Transaction = IBT
    BufferChunks = 1000
  ...
  object DSCustoNFeListagem: TDataSource
    DataSet = TCustoNFeListagem
    Left = 344
    Top = 288
  end
