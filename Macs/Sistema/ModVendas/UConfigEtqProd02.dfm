inherited FConfigEtq02: TFConfigEtq02
  Left = 388
  Top = 30
  Caption = 'FConfigEtq02'
  ClientHeight = 500
  ClientWidth = 510
  OldCreateOrder = True
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object Label35: TLabel [0]
    Left = 15
    Top = 483
    Width = 155
    Height = 13
    Caption = 'Linha/coluna = 23,45 x mm'
  ...
  object GroupBox1: TGroupBox
    ...
    object Label34: TLabel
      ...
      Width = 173
      Height = 16
      Caption = 'Nome Impressora Etiqueta'
    end
    ...
    object DBTextoPersonalizado: TDBColorEdit
      Left = 40
      Top = 68
      Width = 385
      Height = 19
      Color = clGradientInactiveCaption
      DataField = 'TEXTOPERSONALIZADO'
      DataSource = DMMACS.DEtqProd
      Font.Charset = ANSI_CHARSET
      Font.Color = clBlue
      Font.Height = -11
  ...
  object Panel1: TPanel
    ...
    object DBGrid2: TDBGrid
      ...
      Color = clWhite
      Ctl3D = True
      DataSource = DMMACS.DItemEtqProd
