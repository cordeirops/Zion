inherited FPedCompra: TFPedCompra
  ...
  inherited PCadastro: TPanel [8]
    ...
    inherited Panel4: TPanel [3]
      ...
      inherited FPLista: TFashionPanel
        Color = 16772332
        TabOrder = 15
        ...
        inherited Panel2: TPanel
          Color = 16772332
          inherited PVendItem: TPanel [6]
            Color = 16772332
            TabOrder = 17
          end
          inherited pPesqBarraInterno: TPanel [7]
            TabOrder = 20
          ...
          inherited BtnInsertProd: TBitBtn [13]
            TabOrder = 8
            OnKeyDown = BtnInsertProdKeyDown
          end
          inherited BtnDeleteList: TBitBtn [14]
            TabOrder = 9
            OnExit = BtnDeleteListExit
          end
          inherited EDQuantidade: TColorEditFloat [15]
            OnEnter = EDQuantidadeEnter
            OnKeyDown = EDQuantidadeKeyDown
          end
          inherited EDValUnit: TColorEditFloat [16]
            OnEnter = EDValUnitEnter
            OnKeyDown = EDValUnitKeyDown
          end
          inherited EDDesc: TColorEditFloat [17]
          end
          inherited EDTotal: TColorEditFloat [18]
            OnKeyDown = EDTotalKeyDown
          end
          inherited BtnAbrePAliq: TBitBtn [19]
            Top = 37
            Height = 11
            OnKeyDown = BtnAbrePAliqKeyDown
          end
          inherited BtnEscolheProc: TBitBtn [20]
            TabOrder = 15
          end
          inherited BTNDEVOLVER: TBitBtn [21]
            TabOrder = 12
          end
          inherited EdLocal: TFlatEdit [22]
            ColorFlat = 16772332
            ParentColor = False
            TabOrder = 14
            OnKeyDown = EdLocalKeyDown
          end
          inherited PLabelConvertion: TPanel [23]
            TabOrder = 10
          end
          inherited PInfoExp: TPanel [24]
            TabOrder = 18
          end
          ...
          inherited PLote: TPanel [26]
            Color = 16772332
            TabOrder = 19
          end
          inherited PSelectLote: TPanel [27]
            TabOrder = 21
          end
        end
  ...
  inherited PTroco: TPanel [11]
  end
  inherited PComunica: TPanel [12]
    Top = 162
  end
  inherited PComissaoBanca: TPanel [13]
  end
  inherited PItensVendaAg: TPanel [14]
    Left = 224
    TabOrder = 11
