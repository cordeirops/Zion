...
uses
  ...
  Qrctrls, Menus, EditFloat, ColorEditFloat, DrLabel, AppEvnts;
...
begin
  inherited;
   Caption:='Entrada de Quantidade em Estoque (correção)';    
...
begin
  ...
  inherited;
   ...
   Then Begin//Caso a combo para impressão de etiqueta esteja marcada, inicia processo
       ...
       DMESTOQUE.TRel.SQL.Add(' SELECT lancent.cod_lanent, subproduto.CONTRINT, subproduto.cor, subproduto.codprodfabr AS CODFAB,  SUBPRODUTO.especificacao, subproduto.descricao AS DESCR, ');
       DMESTOQUE.TRel.SQL.Add(' estoque.vendvarv as PRECO, subproduto.cor, SubProduto.Marca as MARCA, produto.descricao AS GRADE, subproduto.localestante AS CODCOMPOSTO, lancent.quantidade As QTD, ');
...
begin
  inherited;
	//INFORMA SQL ADEQUADA A IMPRESSAO DE ETIQUETAS
       DMESTOQUE.TRel.CLOSE;
       DMESTOQUE.TRel.SQL.Clear;
       DMESTOQUE.TRel.SQL.Add(' SELECT lancent.cod_lanent, subproduto.codprodfabr AS CODFAB,  SUBPRODUTO.especificacao, subproduto.descricao AS DESCR,  subproduto.FABRICANTE, ');
       DMESTOQUE.TRel.SQL.Add(' estoque.vendvarv as PRECO,  subproduto.cor, SubProduto.Marca as MARCA,  estoque.ultcompra as DTCAD, subproduto.localestante AS CODCOMPOSTO, lancent.quantidade As QTD, subproduto.contrint, subproduto.CLASSIFICACAO, ');
       DMESTOQUE.TRel.SQL.Add(' estoque.vendvarp as PRECOPRAZO, estoque.ultcompra as DTCAD, subproduto.altura AS ALTURA, subproduto.LARGURA AS LARGURA, subproduto.composicao AS COMPOSICAO,');
       // VERIFICA QUAL CÓDIGO DEVE SER IMPRESSO COMO CÓDIGO DE BARRAS
     	DMESTOQUE.TRel.SQL.Add(' subproduto.codbarra AS CODBARRA');
       DMESTOQUE.TRel.SQL.Add(' from lancent ');
...
begin
  inherited;
       ...
       DMESTOQUE.TRel.CLOSE;
       DMESTOQUE.TRel.SQL.Clear;
       DMESTOQUE.TRel.SQL.Add(' SELECT lancent.cod_lanent, subproduto.codprodfabr AS CODFAB,  SUBPRODUTO.especificacao, subproduto.descricao AS DESCR, ');
       DMESTOQUE.TRel.SQL.Add(' estoque.vendvarv as PRECO, subproduto.cor, subproduto.localestante AS CODCOMPOSTO, lancent.quantidade As QTD, ');
...
begin
  inherited;
       ...
       DMESTOQUE.TRel.CLOSE;
       DMESTOQUE.TRel.SQL.Clear;
       DMESTOQUE.TRel.SQL.Add(' SELECT lancent.cod_lanent, subproduto.cor, subproduto.codprodfabr AS CODFAB,  SUBPRODUTO.especificacao, subproduto.descricao AS DESCR, ');
