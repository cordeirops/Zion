...
Uses UDMEstoque, UDMEntrada, UMenu, Alxor32, Alxorprn, UDMSaida, UDMMacs,
    ...
    UPadraoFiscal, USenha, URelDestinatario;
...
Var
    ...
    xCodImpNfeFinanc, xIntervaloDias: Integer;
Begin
    Inherited;
    ...
    Begin
        ...
        Begin
           //Paulo 20/09/2010: insere os itens em uma tabela temporaria
            ...
            DMENTRADA.TImpNfeTMP.SQL.Add('QUANTIDADE, QTDEMB, VALORUN,VALORTOTAL,CST,ALIQICMS,VALORICMS,COD_ESTOQUE,STATUS,CODPRODUTO,');
            DMENTRADA.TImpNfeTMP.SQL.Add('BASESUBST, ICMSSUBST, VALORBASE, IPI, VALORIPI, VALORVENDA, CFOP, DESCPRODVINCULADO)');
            DMENTRADA.TImpNfeTMP.SQL.Add('values(:CODPRODFORN,:CODBARRA,:DESCPROD,:NCM,:TIPOUNIDADE,:QUANTIDADE, :QTDEMB, :VALORUN,:VALORTOTAL,:CST,:ALIQICMS,');
            DMENTRADA.TImpNfeTMP.SQL.Add(':VALORICMS,:CODESTOQ,:STATUS,:CODPRODUTO, :BASESUBST,:ICMSSUBST,:VALORBASE,:IPI,:VALORIPI, :VALORVENDA,:CFOP, :DESCVINC)');
            ...
            Try
                ...
                If ((XIcmsFilho = 'ICMSSN101') Or (XIcmsFilho = 'ICMSSN102') Or (XIcmsFilho = 'ICMSSN201') Or (XIcmsFilho = 'ICMSSN202') Or (XIcmsFilho = 'ICMSSN500') Or (XIcmsFilho = 'ICMSSN900'))
                Then Begin //SIMPLES
                ...
                Else Begin //NORMAL
                    ...
                    If ((XIcmsFilho = 'ICMS00') Or (XIcmsFilho = 'ICMS51') Or (XIcmsFilho = 'ICMS20') Or (XIcmsFilho = 'ICMS40'))
                    ...
                    Else Begin//Imposto com substituição tributária
                        If ((XIcmsFilho = 'ICMS60') Or (XIcmsFilho = 'ICMS10') Or (XIcmsFilho = 'ICMS90') Or (XIcmsFilho = 'ICMS70')) Then
            ...
            DMESTOQUE.Alx3.Close;
            DMESTOQUE.Alx3.SQL.Clear;
            DMESTOQUE.Alx3.SQL.Add('select codigobarra.cod_estoque, estoque.vendvarv, subproduto.cod_produto, subproduto.descricao');
            DMESTOQUE.Alx3.SQL.Add('from codigobarra');
            DMESTOQUE.Alx3.SQL.Add('left join estoque on codigobarra.cod_estoque = estoque.cod_estoque');
...
Begin
   ...
   begin
    ...
    End;
    DMENTRADA.TImpNfeTMP.ParamByName('VALORBASE').AsFloat := 0;//BC do ICMS
End;                                                          
