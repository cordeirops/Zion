...
uses UDMEstoque, UMenu, UDMPessoa, UFORNECEDOR, UCliente, UFuncionario,
  Alxor32, UDMMacs, UPadrao, UDmServ;
...
Begin
   ...
   Then Begin
       DMESTOQUE.TRel.Close;
       DMESTOQUE.TRel.SQL.Clear;
       DMESTOQUE.TRel.sql.Add(' Select ordem.comissao, ordem.desconto, ordem.dtabert, ordem.dtfech, ordem.dtprev, ordem.dtentrega, ');
   ...
   Else Begin
       ...
       Then Begin//se realisar relatório apenas de baixados
           DMESTOQUE.TRel.SQL.Add(' AND (ORDEM.STATUS='+#39+'FECHADO'+#39+')');
       End;
   	//ALEX- 03/10/2017: Filtra resultado por VENDEDOR
   	if(FrmVendedor.EdDescricao.Text <> '')
		Then Begin
   		DMESTOQUE.TRel.sQL.Add(' and (ordem.cod_vendedor = :cod_vendedor) ');
       	DMESTOQUE.TRel.ParamByName('cod_vendedor').AsInteger := xcodVendedor;
   	End;
       DMESTOQUE.TRel.sql.Add(' Order By pessoa.nome ');
       DMESTOQUE.TRel.SQL.Text;
       DMESTOQUE.TRel.Open;
...
begin
  inherited;
   ...
   begin
       ...
       RGTipoData.SendToBack;   
       If (FMenu.TIPOREL='RELORDEM')
       Then Begin
           RGTipoData.Visible:=True;
           RGTipoData.BringToFront;
       End;
   ...
   Then Begin
       ...
       If FMenu.TIPOREL = 'RELOSANALITICOSERVAGRUPADO' then
           Caption:='Relatório de Serviços Agrupados';
       if FMenu.TIPOREL = 'RELOSANALITICOPRODAGRUPADO' then
           Caption:='Relatório de Produtos Agrupados';
       ...
       if FMenu.TIPOREL='RELOSSERVICOSCLIENTE' then
           Caption:='Relatório de Serviços por Cliente';
...
procedure TFRelOrdem.FrmVendedorBTNMINUSClick(Sender: TObject);
begin
  inherited;
     xcodVendedor:=-1;
...
procedure TFRelOrdem.FrmVendedorBTNOPENClick(Sender: TObject);
begin
  inherited;
...
procedure TFRelOrdem.FrmVendedorEDCodigoKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
  inherited;
    If Key=VK_RETURN
