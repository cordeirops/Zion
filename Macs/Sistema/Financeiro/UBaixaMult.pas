...
uses
  ...
  Grids, DBGrids, DBCtrls, UFrmBusca, QRCtrls, QuickRpt, Mask,
...
Begin
           ...
           begin //baixa todos os documentos selecionados
              ...
              then begin
                   ...
                   Else Begin
                      ...
                      DMCONTA.TParcCR.FieldByName('VALORPG').AsCurrency:= 0.00; {DMCONTA.TParcCR.FieldByName('VALOR').AsCurrency;}
           ...
           begin //baixa todos os documentos selecionados
              ...
              then begin
                   ...
                   Else Begin
                      ...
                      DMCONTA.TParcCP.FieldByName('VALORPG').AsCurrency:= 0.00; {DMCONTA.TParcCP.FieldByName('VALOR').AsCurrency;}
   ...
   Begin
       ...
       Then Begin
       	If FiltraTabela(DMCONTA.TParcCP, 'PARCELACP', 'COD_PARCELACP', DMESTOQUE.Alx2.FIELDBYNAME('COD_PARCELACP').AsString, '')=True
        	Then Begin
           	Try //Edmar - 16/07/2014 - Se não foi à vista seta R$ 0.00 no valor pago
