inherited FBaixaContaReceber: TFBaixaContaReceber
  ...
  inherited PJUROS: TPanel
    Top = 82
  end
  inherited EdVenc: TEdit
    Top = 57
  end
  inherited EdValor: TColorEditFloat
    Top = 57
  end
  ...
  inherited EdParcela: TEdit
    Top = 57
  end
  inherited EdDocumento: TEdit
    Top = 57
  end
  inherited EDValorJurMulta: TColorEditFloat
    Top = 114
  end
  inherited DBHISTORICO: TDBEdit
    DataField = 'HISTORICO'
    DataSource = DMFINANC.DCartao
  end
  inherited EDDeb: TColorMaskEdit
    Top = 57
  end
  inherited QRReciboGFinal: TQuickRep
    Functions.DATA = (
      '0'
      '0'
      #39#39)
