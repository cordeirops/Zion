...
type
  ...
  TDMCONTA = class(TDataModule)
    ...
    TPlnCtaRELGERENCIAL: TIBStringField;
    TParcCRCOD_ABCAIXA: TIntegerField;
    TParcCRNOSSONUMBLT: TIBStringField;
    TParcCRDIAS_PROTESTO: TIBStringField;
    TParcCRVALOR_MULTABOLETO: TIBBCDField;
    TParcCRVALOR_JUROSBOLETO: TIBBCDField;
    TParcCPCHEQUES: TIBStringField;
    WParPCHEQUES: TIBStringField;
    WParPRAZAOSOCIAL: TIBStringField;
    TParcCRANTECIPADO: TIBStringField;
    WParRANTECIPADO: TIBStringField;
  private
