object DMCONTA: TDMCONTA
  ...
  object TPlnCta: TIBQuery
    ...
    object TPlnCtaRELGERENCIAL: TIBStringField
      FieldName = 'RELGERENCIAL'
      Origin = 'PLNCTA.RELGERENCIAL'
      FixedChar = True
      Size = 1
    end
  end
  ...
  object TParcCP: TIBQuery
    ...
    object TParcCPCHEQUES: TIBStringField
      FieldName = 'CHEQUES'
      Origin = 'PARCELACP.CHEQUES'
      Size = 100
    end
  end
  ...
  object TParcCR: TIBQuery
    ...
    object TParcCRCOD_ABCAIXA: TIntegerField
      FieldName = 'COD_ABCAIXA'
      Origin = 'PARCELACR.COD_ABCAIXA'
    end
    object TParcCRNOSSONUMBLT: TIBStringField
      FieldName = 'NOSSONUMBLT'
      Origin = 'PARCELACR.NOSSONUMBLT'
    end
    object TParcCRDIAS_PROTESTO: TIBStringField
      FieldName = 'DIAS_PROTESTO'
      Origin = 'PARCELACR.DIAS_PROTESTO'
      Size = 10
    end
    object TParcCRVALOR_MULTABOLETO: TIBBCDField
      FieldName = 'VALOR_MULTABOLETO'
      Origin = 'PARCELACR.VALOR_MULTABOLETO'
      Precision = 18
      Size = 2
    end
    object TParcCRVALOR_JUROSBOLETO: TIBBCDField
      FieldName = 'VALOR_JUROSBOLETO'
      Origin = 'PARCELACR.VALOR_JUROSBOLETO'
      Precision = 18
      Size = 2
    end
    object TParcCRANTECIPADO: TIBStringField
      FieldName = 'ANTECIPADO'
      Origin = 'PARCELACR.ANTECIPADO'
      FixedChar = True
      Size = 1
    end
  end
  object UPlnCta: TIBUpdateSQL
    ...
    InsertSQL.Strings = (
      'insert into PLNCTA'
        ...
        'L, CONTAPADRAO, '
      '   COD_ESTOQUE, MOSTRANORMAL, RELGERENCIAL)'
      'values'
        ...
        '   :MARKREL, :CONTAPADRAO, :COD_ESTOQUE, :MOSTRANORMAL, :RELGERE' +
        'NCIAL)')
    DeleteSQL.Strings = (
      'delete from PLNCTA'
      'where'
  ...
  object UParcCR: TIBUpdateSQL
    ...
    ModifySQL.Strings = (
      ...
      '  VALOR_MULTABOLETO = :VALOR_MULTABOLETO,'
      '  VALOR_JUROSBOLETO = :VALOR_JUROSBOLETO,'
    ...
    InsertSQL.Strings = (
      'insert into PARCELACR'
        ...
        '   EXPORTA, DIASATRASO, NUMORDEM, PARCIAL, ESTRU, COD_ABCAIXA, V' +
        'ALOR_MULTABOLETO, '
      '   VALOR_JUROSBOLETO, DIAS_PROTESTO, ANTECIPADO)'
      'values'
        ...
        '   :ESTRU, :COD_ABCAIXA, :VALOR_MULTABOLETO, :VALOR_JUROSBOLETO,' +
        ' :DIAS_PROTESTO, '
      '   :ANTECIPADO)')
    DeleteSQL.Strings = (
  ...
  object WParP: TIBQuery
    ...
    object WParPCHEQUES: TIBStringField
      FieldName = 'CHEQUES'
      Origin = 'VWPARCP.CHEQUES'
      Size = 100
    end
    object WParPRAZAOSOCIAL: TIBStringField
      FieldName = 'RAZAOSOCIAL'
      Origin = 'VWPARCP.RAZAOSOCIAL'
      Size = 100
    end
  end
  ...
  object WParR: TIBQuery
    ...
    object WParRANTECIPADO: TIBStringField
      FieldName = 'ANTECIPADO'
      Origin = 'VWPARCR.ANTECIPADO'
      FixedChar = True
      Size = 1
    end
  end
