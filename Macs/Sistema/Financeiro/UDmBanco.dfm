object DMBANCO: TDMBANCO
  ...
  object TCtaCor: TIBQuery
    ...
    object TCtaCorUSACOBREBEMX: TIBStringField
      FieldName = 'USACOBREBEMX'
      Origin = 'CTACOR.USACOBREBEMX'
      FixedChar = True
      Size = 1
    end
    object TCtaCorLICENSACOBREBEM: TIBStringField
      FieldName = 'LICENSACOBREBEM'
      Origin = 'CTACOR.LICENSACOBREBEM'
      Size = 200
    end
    object TCtaCorNOVOLAYOUT: TIBStringField
      FieldName = 'NOVOLAYOUT'
      Origin = 'CTACOR.NOVOLAYOUT'
      FixedChar = True
      Size = 1
    end
    object TCtaCorNOME_REMESSA: TIBStringField
      FieldName = 'NOME_REMESSA'
      Origin = 'CTACOR.NOME_REMESSA'
      Size = 50
    end
    object TCtaCorCAMINHO_REMESSA: TIBStringField
      FieldName = 'CAMINHO_REMESSA'
      Origin = 'CTACOR.CAMINHO_REMESSA'
      Size = 200
    end
    object TCtaCorPREFIXO_NOSSONUM: TIntegerField
      FieldName = 'PREFIXO_NOSSONUM'
      Origin = 'CTACOR.PREFIXO_NOSSONUM'
    end
    object TCtaCorCODCEDENTEBLT: TIBStringField
      FieldName = 'CODCEDENTEBLT'
      Origin = 'CTACOR.CODCEDENTEBLT'
    end
    object TCtaCorBLT_REGISTRADO: TIBStringField
      FieldName = 'BLT_REGISTRADO'
      Origin = 'CTACOR.BLT_REGISTRADO'
      FixedChar = True
      Size = 1
    end
    object TCtaCorCONTA_CONTABIL: TIBStringField
      FieldName = 'CONTA_CONTABIL'
      Origin = 'CTACOR.CONTA_CONTABIL'
    end
    object TCtaCorCODCEDENTEBLT_REG: TIBStringField
      FieldName = 'CODCEDENTEBLT_REG'
      Origin = 'CTACOR.CODCEDENTEBLT_REG'
    end
    object TCtaCorDIGCODCEDENTEBLT_REG: TIBStringField
      FieldName = 'DIGCODCEDENTEBLT_REG'
      Origin = 'CTACOR.DIGCODCEDENTEBLT_REG'
      FixedChar = True
      Size = 1
    end
    object TCtaCorNUMAGENCBLT_REG: TIBStringField
      FieldName = 'NUMAGENCBLT_REG'
      Origin = 'CTACOR.NUMAGENCBLT_REG'
      Size = 10
    end
    object TCtaCorDIGAGENCBLT_REG: TIBStringField
      FieldName = 'DIGAGENCBLT_REG'
      Origin = 'CTACOR.DIGAGENCBLT_REG'
      Size = 10
    end
    object TCtaCorCODCARTEIRABLT_REG: TIBStringField
      FieldName = 'CODCARTEIRABLT_REG'
      Origin = 'CTACOR.CODCARTEIRABLT_REG'
      Size = 3
    end
    object TCtaCorNOSSONUMBLT_REG: TIBStringField
      FieldName = 'NOSSONUMBLT_REG'
      Origin = 'CTACOR.NOSSONUMBLT_REG'
      Size = 15
    end
    object TCtaCorPREFIXO_NOSSONUM_REG: TIntegerField
      FieldName = 'PREFIXO_NOSSONUM_REG'
      Origin = 'CTACOR.PREFIXO_NOSSONUM_REG'
    end
    object TCtaCorCODMODALIDADE_REG: TIBStringField
      FieldName = 'CODMODALIDADE_REG'
      Origin = 'CTACOR.CODMODALIDADE_REG'
      Size = 15
    end
    object TCtaCorPROXBOLETO_REG: TIntegerField
      FieldName = 'PROXBOLETO_REG'
      Origin = 'CTACOR.PROXBOLETO_REG'
    end
    object TCtaCorCONTREMESSA_REG: TIntegerField
      FieldName = 'CONTREMESSA_REG'
      Origin = 'CTACOR.CONTREMESSA_REG'
    end
    object TCtaCorCOBRANCA_BB: TIBStringField
      FieldName = 'COBRANCA_BB'
      Origin = 'CTACOR.COBRANCA_BB'
      Size = 1
    end
    object TCtaCorCOBRANCA_BANCOOB: TIBStringField
      FieldName = 'COBRANCA_BANCOOB'
      Origin = 'CTACOR.COBRANCA_BANCOOB'
      Size = 1
    end
    object TCtaCorCPFCNPJ_BOLETO: TIBStringField
      FieldName = 'CPFCNPJ_BOLETO'
      Origin = 'CTACOR.CPFCNPJ_BOLETO'
      Size = 14
    end
    object TCtaCorNOME_EXIBICAO_BOLETO: TIBStringField
      FieldName = 'NOME_EXIBICAO_BOLETO'
      Origin = 'CTACOR.NOME_EXIBICAO_BOLETO'
      Size = 100
    end
    object TCtaCorINATIVO: TIBStringField
      FieldName = 'INATIVO'
      Origin = 'CTACOR.INATIVO'
      FixedChar = True
      Size = 1
    end
  end
  ...
  object UCtaCor: TIBUpdateSQL
    RefreshSQL.Strings = (
      ...
      '  BLT_REGISTRADO,'
      '  CODCEDENTEBLT_REG,'
      '  DIGCODCEDENTEBLT_REG,'
      '  NUMAGENCBLT_REG,'
      '  DIGAGENCBLT_REG,'
      '  CODCARTEIRABLT_REG,'
      '  NOSSONUMBLT_REG,'
      '  PREFIXO_NOSSONUM_REG,'
      '  CODMODALIDADE_REG,'
      '  PROXBOLETO_REG,'
      '  CONTREMESSA_REG,'
      '  CPFCNPJ_BOLETO,'
      '  NOME_EXIBICAO_BOLETO,'
      '  COBRANCA_BB,'
      '  COBRANCA_BANCOOB,'
      '  INATIVO'
      'from CTACOR '
    ...
    ModifySQL.Strings = (
      ...
      '  LICENSACOBREBEM = :LICENSACOBREBEM,'
      '  USACOBREBEMX = :USACOBREBEMX,'
      '  PREFIXO_NOSSONUM = :PREFIXO_NOSSONUM,'
      '  CAMINHO_REMESSA = :CAMINHO_REMESSA,'
      '  NOME_REMESSA = :NOME_REMESSA,'
      '  NOVOLAYOUT = :NOVOLAYOUT,'
      '  CONTA_CONTABIL = :CONTA_CONTABIL,'
      '  BLT_REGISTRADO = :BLT_REGISTRADO,'
      '  CODCEDENTEBLT_REG = :CODCEDENTEBLT_REG,'
      '  DIGCODCEDENTEBLT_REG = :DIGCODCEDENTEBLT_REG,'
      '  NUMAGENCBLT_REG = :NUMAGENCBLT_REG,'
      '  DIGAGENCBLT_REG = :DIGAGENCBLT_REG,'
      '  CODCARTEIRABLT_REG = :CODCARTEIRABLT_REG,'
      '  NOSSONUMBLT_REG = :NOSSONUMBLT_REG,'
      '  PREFIXO_NOSSONUM_REG = :PREFIXO_NOSSONUM_REG,'
      '  CODMODALIDADE_REG = :CODMODALIDADE_REG,'
      '  PROXBOLETO_REG = :PROXBOLETO_REG,'
      '  CONTREMESSA_REG = :CONTREMESSA_REG,'
      '  CPFCNPJ_BOLETO = :CPFCNPJ_BOLETO,'
      '  NOME_EXIBICAO_BOLETO = :NOME_EXIBICAO_BOLETO,'
      '  COBRANCA_BB = :COBRANCA_BB,'
      '  COBRANCA_BANCOOB = :COBRANCA_BANCOOB,'
      '  INATIVO = :INATIVO'
      'where'
    ...
    InsertSQL.Strings = (
      'insert into CTACOR'
        ...
        '   PROTAUT, CODEMPRESABLT, LICENSACOBREBEM, USACOBREBEMX, PREFIX' +
        'O_NOSSONUM, '
      
        '   CAMINHO_REMESSA, NOME_REMESSA, NOVOLAYOUT, CONTA_CONTABIL, BL' +
        'T_REGISTRADO, '
      
        '   CODCEDENTEBLT_REG, DIGCODCEDENTEBLT_REG, NUMAGENCBLT_REG, DIG' +
        'AGENCBLT_REG, '
      
        '   CODCARTEIRABLT_REG, NOSSONUMBLT_REG, PREFIXO_NOSSONUM_REG, CO' +
        'DMODALIDADE_REG, '
      
        '   PROXBOLETO_REG, CONTREMESSA_REG, CPFCNPJ_BOLETO, NOME_EXIBICA' +
        'O_BOLETO, '
      '   COBRANCA_BB, COBRANCA_BANCOOB, INATIVO)'
      'values'
        ...
        '   :CONTREMESSA, :DIASPROT, :PROTAUT, :CODEMPRESABLT, :LICENSACO' +
        'BREBEM, '
      
        '   :USACOBREBEMX, :PREFIXO_NOSSONUM, :CAMINHO_REMESSA, :NOME_REM' +
        'ESSA, :NOVOLAYOUT, '
      
        '   :CONTA_CONTABIL, :BLT_REGISTRADO, :CODCEDENTEBLT_REG, :DIGCOD' +
        'CEDENTEBLT_REG, '
      
        '   :NUMAGENCBLT_REG, :DIGAGENCBLT_REG, :CODCARTEIRABLT_REG, :NOS' +
        'SONUMBLT_REG, '
      
        '   :PREFIXO_NOSSONUM_REG, :CODMODALIDADE_REG, :PROXBOLETO_REG, :' +
        'CONTREMESSA_REG, '
      
        '   :CPFCNPJ_BOLETO, :NOME_EXIBICAO_BOLETO, :COBRANCA_BB, :COBRAN' +
        'CA_BANCOOB, '
      '   :INATIVO)')
    DeleteSQL.Strings = (
      'delete from CTACOR'
  ...
  object WCtaCor: TIBQuery
    ...
    object WCtaCorINATIVO: TIBStringField
      FieldName = 'INATIVO'
      Origin = 'VWCTACOR.INATIVO'
      FixedChar = True
      Size = 1
    end
  end
  ...
  object TMovBanco: TIBQuery
    ...
    GeneratorField.Field = 'COD_MOVBANCO'
    GeneratorField.Generator = 'GEN_MOVBANCO_ID'
    Left = 176
    Top = 81
  ...
  object TAbBanco: TIBQuery
    ...
    object TAbBancoMARK: TIBStringField
      FieldName = 'MARK'
      Origin = 'ABBANCO.MARK'
      Size = 1
    end
  ...
  object UAbBanco: TIBUpdateSQL
    ...
    InsertSQL.Strings = (
      'insert into ABBANCO'
        ...
        ' '
      'SALDOFIN, '
      '   DTFECH, HORAFECH, FECHADO, COD_USUARIO, MARK)'
      'values'
      '  (:COD_ABBANCO, :COD_CTACOR, :DATA_ABERT, :HORA_ABERTURA, '
      ':SALDOINI, :SALDOFIN, '
      '   :DTFECH, :HORAFECH, :FECHADO, :COD_USUARIO, :MARK)')
    DeleteSQL.Strings = (
      'delete from ABBANCO'
