inherited FLancCaixa: TFLancCaixa
  ...
  object PListContas: TPanel
    ...
    object Panel1: TPanel
      ...
      Height = 41
      Align = alTop
      Caption = 'Listagem de Lan'#231'amentos por Conta'
      Color = 16121836
  ...
  object PMRELCAIXA: TPopupMenu
    ...
    object BalanceteMensalporPerodo1: TMenuItem
      Caption = 'Balancete de Contas por Per'#237'odo'
      OnClick = BalanceteMensalporPerodo1Click
    end
    ...
    object ListagemdeLanamentosporCaixa1: TMenuItem
      Caption = 'Listagem de Lan'#231'amentos por Caixa'
      OnClick = ListagemdeLanamentosporCaixa1Click
    end
    object Listagemdelanamentosporcontas1: TMenuItem
      Caption = 'Listagem de Lan'#231'amentos por Conta'
      OnClick = Listagemdelanamentosporcontas1Click
    end
  end
  object PMCheque: TPopupMenu
    ...
    object ransferirTodososCheques1: TMenuItem
      Caption = 'Transferir todos os cheques'
      OnClick = ransferirTodososCheques1Click
    end
    object N2: TMenuItem
      Caption = '-'
    end
