inherited FCtaReceber: TFCtaReceber
  ...
  inherited PConsultParc: TPanel [1]
    Left = 5
    Top = 5
    Width = 868
    Height = 490
  ...
  inherited PCONSULTA: TPanel [2]
    ...
    inherited TCConsultContas: TFlatTabControl
      ...
      inherited PIndividual: TPanel [1]
        Width = 859
        Height = 421
        ...
        object PBoletoManual: TPanel [17]
          Left = 5
          Top = 181
          Width = 344
          Height = 161
