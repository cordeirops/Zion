inherited FRelCtaPR: TFRelCtaPR
  ...
  object rgFiltroTipoRel: TRadioGroup
    Left = 377
    Top = 10
    Width = 88
    Height = 82
  ...
  object GBContasAntecipadas: TGroupBox
    Left = 13
    Top = 128
    Width = 537
    Height = 32
    Caption = 'Contas antecipadas'
    Color = clWhite
    Ctl3D = True
    ParentColor = False
    ParentCtl3D = False
    ...
    TabStop = True
    Visible = False
    object CBAntecipadoSemFiltro: TCheckBox
      Left = 93
      Top = 11
      Width = 68
      Height = 17
      Caption = 'Sem filtro'
      TabOrder = 0
      OnClick = CBAntecipadoSemFiltroClick
    end
    object CbAntecipadoSomenteAntecipados: TCheckBox
      Left = 200
      Top = 11
      Width = 125
      Height = 17
      Caption = 'Somente antecipadas'
      TabOrder = 1
      OnClick = CbAntecipadoSomenteAntecipadosClick
    end
    object CBAntecipadosSomenteNaoAntecipados: TCheckBox
      Left = 351
      Top = 11
      Width = 150
      Height = 17
      Caption = 'Somente n'#227'o antecipadas'
      TabOrder = 2
      OnClick = CBAntecipadosSomenteNaoAntecipadosClick
    end
  end
