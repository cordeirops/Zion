    ...
    Then Begin
	    Try
          ...
          Then Begin// caso haja retirada de caixa para fechamento lançar em caixa
        	  If LanCaixa (0, DateToStr(Date()), DMMacs.TLoja.FieldByName('plncta_retcai').Value, 'RET. FECHAMENTO DO CAIXA - '+FMenu.LCAIXA.Caption+ ' EM '+EDData.Text+'/'+EDHora.Text, EdRetirada.ValueNumeric, 'FCCAIXA', StrToInt(FMenu.LABCAIXA.Caption), 'Carteira', 'S', '', Date(), '1')=True
             Then Begin
