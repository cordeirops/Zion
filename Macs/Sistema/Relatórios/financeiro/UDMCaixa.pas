...
Begin
   ...
   Then Begin
       ...
       FMenu.LCAIXA.Font.Color:=clTeal;
       FMenu.LCAIXA.Hint:='Este caixa se encontra aberto';
   ...
   Else Begin
       ...
       FMenu.LCAIXA.Font.Color:=clMaroon;
       FMenu.LCAIXA.Hint:='Este caixa se encontra fechado';
