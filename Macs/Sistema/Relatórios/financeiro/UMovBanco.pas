...
type
  TFMovBanco = class(TFCadPadraoRodaPe)
    ...
    Label10: TLabel;
    Label11: TLabel;
    DBDTLanc: TDBColorEdit;
    DBHsLanc: TDBColorEdit;
    DBDTVenc: TDBColorEdit;
    DBHistorico: TDBColorEdit;
    DBValor: TDBColorEdit;
    DBOperacao: TDBColorComboBox;
    DBCobranca: TDBColorComboBox;
    DBColorComboBox3: TDBColorComboBox;
    EdTotMov: TFloatEdit;
...
var
  ...
  XSALDO: Real;
  XCOD_CX: INTEGER;
  XCODMOVBANCO, XCODLANCH: Integer;// Chaves Primarias para lançamento de cheques de transf de banco
  XCODBANCO: Integer;
implementation
...
begin
  inherited;
   ...
   Then Begin
   	Oper:=' ';
   	//verifica o tipo do operador para selecionar contas
   	If DBOperacao.Text='ENTRADA' Then
       	Oper:='C';
   	If DBOperacao.Text='SAIDA' Then
       	Oper:='D';
...
begin
   ...
   If (DBCobranca.Text='CHEQUE') AND (DBOperacao.Text='ENTRADA')
   Then Begin
   ...
   If (DBCobranca.Text='CHEQUE') AND (DBOperacao.Text='SAIDA')
   Then Begin
   ...
   Try
      ...
      if DBColorEdit1.Text <> '  /  /    '
      then begin
           XTabela.FieldByName('DTMOV').AsString:=DBColorEdit1.Text;
      end;
           ...
           Then Begin
               ...
               Then Begin
                   ...
                   Then Begin
                      ...
                      If DBColorEdit1.Text <> '  /  /    '
                      Then Begin
                           DMCONTA.TParcCR.FieldByName('DTDEBITO').AsString := DBColorEdit1.Text;
                      End
                      Else Begin
...
begin
  ...
  // - 19/02/2009:  fim
   ...
   Then Begin
  		...
  		DBHsLanc.Text:=TimeToStr(Time());
  		XTabela.FieldByName('DTVENC').AsString:=DateToStr(Date());
  		XTabela.FieldByName('DTLANC').AsString:=DateToStr(Date());
  		inherited;
       XSTATUSCHEQUE:='INSERT';
       EdNumAg.Text:='';
       EdNumConta.Text:='';
       ...
       Then Begin
   		...
   		Then Begin
           	...
           	Then Begin
               	...
               	EDPORTADOR.Text:=DMBANCO.TChequeRec.FieldByName('PORTADOR').AsString;
          ...
          Then Begin
            ...
            DBColorEdit1.Text := XTabela.FieldByName('DTMOV').AsString;
          End
          Else Begin
...
begin
  inherited;
   ...
   Then Begin
       ...
       Then Begin
	       RGMOVIMENTO.ItemIndex:=0;
	       DBColorEdit1.Text:=DateToStr(Date());          
       End
	    Else Begin
	       RGMOVIMENTO.ItemIndex:=1;
       End;
...
//           RGMOVIMENTO.Enabled:=False;
       ...
       End;
       If  (DBOperacao.Text<>'ENTRADA') AND (DBOperacao.Text<>'SAIDA')
