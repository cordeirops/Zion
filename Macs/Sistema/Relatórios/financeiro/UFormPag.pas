...
begin
    ...
    THEN Begin
        DBDESC.Text:= 'CADERNETA'; //forma de pagamento será a vista
        ...
        Then Begin//não pode haver duas formas de pagamento=' à vista
	         Mensagem('OPÇÃO BLOQUEADA', 'Esta forma de pagamento é descrita com pagto CADERNETA. Porém ja existe uma forma de pagamento deste tipo!', '', 1, 1, False, 'a');
       	 exit;
        End;
    End;
