object DMCAIXA: TDMCAIXA
  ...
  object TAlx: TIBQuery
    ...
    SQL.Strings = (
        ...
        'Select caixausu.cod_caixausu, caixausu.dtcad, caixausu.hora1,  c' +
        'aixausu.hora2, caixausu.primdia, Loja.Descricao, caixausu.ultdia' +
        ', caixa.cod_caixa, caixa.descricao '
      'from caixa join caixaUSU'
      '        on caixausu.cod_caixa = caixa.cod_caixa '
      '                 Join LOJA'
      '         on Caixa.Cod_loja = Loja.Cod_Loja ')
    Left = 99
    Top = 8
  end
