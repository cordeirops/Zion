...
begin
  inherited;
   ...
   Else Begin
       ...
       EdDestinoChq.Text:='Cx. '+FMenu.LCAIXA.Caption;
   End;
end;
  ...
  inherited;
   ...
   Then Begin
       ...
       DMBANCO.TAlx.ParamByName('CODGERADOR').AsString:=DMBANCO.WChequeRec.FieldByName('COD_CHEQUEREC').AsString;
		DMBANCO.TAlx.Open;
		If not DMBANCO.TAlx.isempty Then
       	FMenu.XCOD_LANCAIXA:=DMBANCO.TAlx.FieldByName('COD_CAIXA').AsInteger;
       //Verifik caixa aberto
       DMCAIXA.VerifAbCaixa;

   	If RGLANCAR.ItemIndex=0 Then
           XHistMov:=' Cx: '+FMenu.LCAIXA.Caption
		Else
   	...
   	Then Begin
           ...
           Try
               ...
               MDO.Query.ParamByName('Destino').AsString:=EdDestinoChq.Text;
           ...
           Try
               ...
               MDO.Query.ParamByName('HISTORICO').AsString:=XHistMov+' / '+DMBANCO.TMovBanco.FieldByName('HISTORICO').AsString;
               MDO.Query.ParamByName('DATA').AsString:=EdDtMovBaixa.Text;
           ...
           Then Begin
   			...
   			Then Begin
               	Try
                   	MDO.Query.Close;
                   	MDO.Query.SQL.Clear;
                   	MDO.Query.SQL.Add('UPDATE PARCELACR SET PARCELACR.FECH =:FECH, PARCELACR.DTDEBITO =:DTDEBITO, PARCELACR.VALORPG =:VALORPG ');
...
begin
  inherited;
	If RGLANCAR.ItemIndex=1 Then
       EdDestinoChq.Text:='Cta. '+FrmCtaCor.EdDescricao.Text;
end;
