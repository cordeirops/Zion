...
type
  TDMESTOQUE = class(TDataModule)
    ...
    DSAlx4: TDataSource;
    TFchTec: TIBQuery;
    UpFchTec: TIBUpdateSQL;
    DFchTec: TDataSource;
    TITProdFT: TIBQuery;
    UITProdFT: TIBUpdateSQL;
    DITProdFT: TDataSource;
    TITServFT: TIBQuery;
    UITServFT: TIBUpdateSQL;
    DITServFT: TDataSource;
    TRel1: TIBQuery;
    DRel1: TDataSource;
    TRel2: TIBQuery;
    DRel2: TDataSource;
    ...
    TFchTecCOD_FCHTECPROD: TIntegerField;
    TFchTecCOD_SUBPRODUTO: TIntegerField;
    TFchTecPORCAO: TIBBCDField;
    TITProdFTCOD_ITFCHTECPROD: TIntegerField;
    TITProdFTCOD_FCHTECPROD: TIntegerField;
    TITProdFTCOD_SUBPRODUTO: TIntegerField;
    TITProdFTQTDUTILIZ: TIBBCDField;
    TITProdFTCLASS: TIBStringField;
    TITProdFTVLRUNIT: TIBBCDField;
    TITProdFTVLRTOT: TIBBCDField;
    TITServFTCOD_ITFCHTECSERV: TIntegerField;
    TITServFTCOD_FCHTECPROD: TIntegerField;
    TITServFTCOD_SUBSERVICO: TIntegerField;
    TITServFTQTDUTILIZ: TIBBCDField;
    TITServFTCLASS: TIBStringField;
    TITServFTVLRUNIT: TIBBCDField;
    TITServFTVLRTOT: TIBBCDField;
