inherited FOrdemMec: TFOrdemMec
  ...
  object PInterfaceValidacoes: TPanel [6]
    Left = 160
    Top = 90
    Width = 377
    Height = 385
  ...
  object PCadastroRapido: TPanel [10]
    Left = 20
    Top = 82
    Width = 769
    Height = 161
  ...
  object PCadastro: TPanel [11]
    ...
    object GBPRINCIPALCADASTRO: TcxGroupBox
      ...
      object PanelPlacaAdicional: TPanel
        Left = 352
        Top = 40
        Width = 297
        Height = 27
        ...
        Color = 16772332
        TabOrder = 19
        object LabelPlacaAdicional: TLabel
          Left = 7
          Top = 5
          Width = 62
          Height = 16
        ...
        object EdPlaca2: TFlatEdit
          ...
          ParentFont = False
          TabOrder = 0
          OnKeyDown = EdPlaca2KeyDown
          OnKeyPress = EdPlaca2KeyPress
        end
        object EdPlaca3: TFlatEdit
          Left = 184
          Top = 1
          Width = 104
          Height = 24
          ...
          ParentFont = False
          TabOrder = 1
          OnKeyDown = EdPlaca3KeyDown
          OnKeyPress = EdPlaca3KeyPress
        end
      end
    end
