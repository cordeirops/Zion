object DMSAIDA: TDMSAIDA
  ...
  object TItemPV: TIBQuery
    ...
    object TItemPVCOEFDIV: TIBBCDField
      FieldName = 'COEFDIV'
  ...
  object UPedV: TIBUpdateSQL
    ...
    InsertSQL.Strings = (
      'insert into PEDVENDA'
        ...
        '   ATUCOMIS, FATURADO, EDIT, EXPORTA, COD_OBRA, CONTROLEFRETE, N' +
        'UMECF, '
      
        '   TIPOIMPFISC, VLROUTROS, VLRIPI, VLRICMSSUBSTITUICAO, CODVEICU' +
        'LOENT, '
      '   VLRVEICULOENT, VLRDESP)'
      'values'
        ...
        'VLRICMSSUBSTITUICAO, '
      '   :CODVEICULOENT, :VLRVEICULOENT, :VLRDESP)')
    DeleteSQL.Strings = (
  ...
  object UItemPV: TIBUpdateSQL
    ...
    InsertSQL.Strings = (
      'insert into ITENSPEDVEN'
        ...
        '   COD_CST, DESCNF, REDUCBASE, APLICARST, VALORTOTALTRIBUTA, ALI' +
        'QUOTATOTALTRIBUTA)'
      'values'
  ...
  object ULancSai: TIBUpdateSQL
    ...
    InsertSQL.Strings = (
      'insert into LANCSAI'
        ...
        'IVO, DT_LANCAMENTO, '
      '   QUANTIDADE, DT_ESTOQUE, QTDANT, COD_LOTE)'
      'values'
  ...
  object UOrc: TIBUpdateSQL
    ...
    InsertSQL.Strings = (
      'insert into ORCAMENTO'
        ...
        '  (COD_ORCAMENTO, COD_USUARIO, COD_VENDEDOR, COD_FORMPAG, COD_LO' +
        'JA, COD_CLIENTE, '
      
        '   NOMECLI, CPFCNPJ, DTABERT, HRABERT, DTVALIDADE, NUMORC, OBS, ' +
        'TIPO, DESCSERV, '
      
        '   DESCPROD, VLRSERV, VLRPROD, VLRTOTAL, VLRDESP, COD_RESTEC, VL' +
        'RRESTEC, '
      '   DESCPRODMOE, DESCRICAO, COD_EQUIPAMENTO, CONTATO)'
      'values'
      
        '  (:COD_ORCAMENTO, :COD_USUARIO, :COD_VENDEDOR, :COD_FORMPAG, :C' +
        'OD_LOJA, '
        ...
        '   :COD_RESTEC, :VLRRESTEC, :DESCPRODMOE, :DESCRICAO, :COD_EQUIP' +
        'AMENTO, '
      '   :CONTATO)')
    DeleteSQL.Strings = (
  ...
  object UpProdOrc: TIBUpdateSQL
    ...
    InsertSQL.Strings = (
      ...
      'values'
        ...
        'VALREP, '
      '   :LUCREL, :COD_UNIDADE, :QTDEMB, :UNIDEMB, :QTDNAEMB)')
    DeleteSQL.Strings = (
