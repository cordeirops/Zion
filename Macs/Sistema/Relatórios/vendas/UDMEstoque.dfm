object DMESTOQUE: TDMESTOQUE
  ...
  object UPSubProd: TIBUpdateSQL
    ...
    InsertSQL.Strings = (
      'insert into SUBPRODUTO'
        ...
        'BALANCA, '
      '   ANVISA, MINSAUDE, DENSIDADE, USOCONSUMO, GERARPISCOFINS)'
      'values'
        ...
        ':MINSAUDE, '
      '   :DENSIDADE, :USOCONSUMO, :GERARPISCOFINS)')
    DeleteSQL.Strings = (
  ...
  object UPCST: TIBUpdateSQL
    ...
    InsertSQL.Strings = (
      'insert into CST'
        ...
        '  (COD_CST, DESCRICAO, COD_SIT_TRIB, INDICEECF, SUBSTITUICAO, RE' +
        'DUCAO, '
      '   VENDA, ISENTA, ICMSOP)'
      'values'
  ...
  object UPEstoque: TIBUpdateSQL
    ...
    InsertSQL.Strings = (
      ...
      'values'
        ...
        'CMST, :IPI_VND, '
      '   :PMC, :MVA, :GERACOMIS, :ATUALIZAR, :ESTLOJA, :EXPORTAR)')
    DeleteSQL.Strings = (
      'delete from ESTOQUE'
      'where'
      '  COD_ESTOQUE = :OLD_COD_ESTOQUE')
  ...
  object Alx: TIBQuery
    ...
    SQL.Strings = (
        ...
        'Select * from plncta where (plncta.cod_estoque=:codigo) and (pln' +
        'cta.tipo='#39'N'#39')'
      'order by plncta.classificacao')
    Left = 168
    ParamData = <
      item
        DataType = ftUnknown
  ...
  object TRel: TIBQuery
    ...
    SQL.Strings = (
        ...
        '  select distinct(pedvenda.numped), vwfuncionario.nome AS VEND, ' +
        'pedvenda.dtfech As DTFECH, vwcliente.nome, pedvenda.valor, comis' +
        'sao.vlrprod,'
      
        '  comissao.perprod, comissao.vlrcomisprod, comissao.vlrserv, com' +
        'issao.perserv, comissao.vlrcomisserv,'
      '  pedvenda.garantia FROM comissao'
      
        '   left join pedvenda ON comissao.cod_gerador=pedvenda.cod_pedve' +
        'nda'
      
        '   left join formpag on pedvenda.cod_formpag = formpag.cod_formp' +
        'ag'
      
        '  left join vwcliente ON pedvenda.cod_cliente = vwcliente.cod_cl' +
        'iente'
      
        '  left join vwfuncionario on comissao.cod_funcionario = vwfuncio' +
        'nario.cod_func'
      
        ' Where (comissao.gerador='#39'PEDVENDA'#39') AND (vwfuncionario.nome Bet' +
        'ween :PES1 And :PES2)  AND (PEDVENDA.DTFECH Between :Data1 and :' +
        'Data2)')
    Left = 221
    Top = 318
    ParamData = <
  ...
  object DBEstoque: TIBDatabase
    DatabaseName = 'server:C:\MZR\DataBase\Mercescan\DBMACS.GDB'
    Params.Strings = (
      'user_name=SYSDBA'
      'password=masterkey'
      'sql_role_name=3'
  ...
  object Alx3: TIBQuery
    ...
    SQL.Strings = (
        ...
        'select funcionario.cod_func, funcionario.cod_pessoa, pessoa.cod_' +
        'pessoa, pessoa.nome,'
      'ordem.cod_ordem, ordem.cod_funcionario'
      'from ordem'
      
        'left join funcionario on ordem.cod_funcionario = funcionario.cod' +
        '_func'
  ...
  object TFchTec: TIBQuery
    ...
    CachedUpdates = False
    SQL.Strings = (
      'select *  from FCHTECPROD')
    UpdateObject = UpFchTec
    GeneratorField.Field = 'COD_ESTOQUE'
    Left = 294
    Top = 183
    object TFchTecCOD_FCHTECPROD: TIntegerField
      FieldName = 'COD_FCHTECPROD'
      Origin = 'FCHTECPROD.COD_FCHTECPROD'
    end
    object TFchTecCOD_SUBPRODUTO: TIntegerField
      FieldName = 'COD_SUBPRODUTO'
      Origin = 'FCHTECPROD.COD_SUBPRODUTO'
    end
    object TFchTecPORCAO: TIBBCDField
      FieldName = 'PORCAO'
      Origin = 'FCHTECPROD.PORCAO'
      Precision = 18
      Size = 3
    end
  end
  object UpFchTec: TIBUpdateSQL
    RefreshSQL.Strings = (
      'Select '
      '  COD_FCHTECPROD,'
      '  COD_SUBPRODUTO,'
    ...
    ModifySQL.Strings = (
      ...
      '  PORCAO = :PORCAO'
      'where'
      '  COD_FCHTECPROD = :OLD_COD_FCHTECPROD')
    InsertSQL.Strings = (
      'insert into FCHTECPROD'
      '  (COD_FCHTECPROD, COD_SUBPRODUTO, PORCAO)'
      'values'
      '  (:COD_FCHTECPROD, :COD_SUBPRODUTO, :PORCAO)')
    DeleteSQL.Strings = (
      'delete from FCHTECPROD'
      'where'
      '  COD_FCHTECPROD = :OLD_COD_FCHTECPROD')
    Left = 294
    Top = 229
  end
  object DFchTec: TDataSource
    DataSet = TFchTec
    Left = 295
    Top = 271
  end
  object TITProdFT: TIBQuery
    Database = DBEstoque
    Transaction = TransacEstoque
    AutoCalcFields = False
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      'select *  from ITFCHTECPROD')
    UpdateObject = UITProdFT
    GeneratorField.Field = 'COD_ESTOQUE'
    Left = 350
    Top = 183
    object TITProdFTCOD_ITFCHTECPROD: TIntegerField
      FieldName = 'COD_ITFCHTECPROD'
      Origin = 'ITFCHTECPROD.COD_ITFCHTECPROD'
    end
    object TITProdFTCOD_FCHTECPROD: TIntegerField
      FieldName = 'COD_FCHTECPROD'
      Origin = 'ITFCHTECPROD.COD_FCHTECPROD'
    end
    object TITProdFTCOD_SUBPRODUTO: TIntegerField
      FieldName = 'COD_SUBPRODUTO'
      Origin = 'ITFCHTECPROD.COD_SUBPRODUTO'
    end
    object TITProdFTQTDUTILIZ: TIBBCDField
      FieldName = 'QTDUTILIZ'
      Origin = 'ITFCHTECPROD.QTDUTILIZ'
      Precision = 18
      Size = 3
    end
    object TITProdFTCLASS: TIBStringField
      FieldName = 'CLASS'
      Origin = 'ITFCHTECPROD.CLASS'
      Size = 25
    end
    object TITProdFTVLRUNIT: TIBBCDField
      FieldName = 'VLRUNIT'
      Origin = 'ITFCHTECPROD.VLRUNIT'
      Precision = 18
      Size = 2
    end
    object TITProdFTVLRTOT: TIBBCDField
      FieldName = 'VLRTOT'
      Origin = 'ITFCHTECPROD.VLRTOT'
      Precision = 18
      Size = 2
    end
  end
  object UITProdFT: TIBUpdateSQL
    RefreshSQL.Strings = (
      'Select '
      '  COD_ITFCHTECPROD,'
      '  COD_FCHTECPROD,'
    ...
    ModifySQL.Strings = (
      ...
      '  VLRTOT = :VLRTOT'
      'where'
      '  COD_ITFCHTECPROD = :OLD_COD_ITFCHTECPROD')
    InsertSQL.Strings = (
      'insert into ITFCHTECPROD'
      
        '  (COD_ITFCHTECPROD, COD_FCHTECPROD, COD_SUBPRODUTO, QTDUTILIZ, ' +
        'CLASS, '
      '   VLRUNIT, VLRTOT)'
      'values'
      
        '  (:COD_ITFCHTECPROD, :COD_FCHTECPROD, :COD_SUBPRODUTO, :QTDUTIL' +
        'IZ, :CLASS, '
      '   :VLRUNIT, :VLRTOT)')
    DeleteSQL.Strings = (
      'delete from ITFCHTECPROD'
      'where'
      '  COD_ITFCHTECPROD = :OLD_COD_ITFCHTECPROD')
    Left = 350
    Top = 229
  end
  object DITProdFT: TDataSource
    DataSet = TITProdFT
    Left = 351
    Top = 271
  end
  object TITServFT: TIBQuery
    Database = DBEstoque
    Transaction = TransacEstoque
    AutoCalcFields = False
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      'select *  from ITFCHTECSERV')
    UpdateObject = UITServFT
    GeneratorField.Field = 'COD_ESTOQUE'
    Left = 406
    Top = 184
    object TITServFTCOD_ITFCHTECSERV: TIntegerField
      FieldName = 'COD_ITFCHTECSERV'
      Origin = 'ITFCHTECSERV.COD_ITFCHTECSERV'
    end
    object TITServFTCOD_FCHTECPROD: TIntegerField
      FieldName = 'COD_FCHTECPROD'
      Origin = 'ITFCHTECSERV.COD_FCHTECPROD'
    end
    object TITServFTCOD_SUBSERVICO: TIntegerField
      FieldName = 'COD_SUBSERVICO'
      Origin = 'ITFCHTECSERV.COD_SUBSERVICO'
    end
    object TITServFTQTDUTILIZ: TIBBCDField
      FieldName = 'QTDUTILIZ'
      Origin = 'ITFCHTECSERV.QTDUTILIZ'
      Precision = 18
      Size = 3
    end
    object TITServFTCLASS: TIBStringField
      FieldName = 'CLASS'
      Origin = 'ITFCHTECSERV.CLASS'
      Size = 25
    end
    object TITServFTVLRUNIT: TIBBCDField
      FieldName = 'VLRUNIT'
      Origin = 'ITFCHTECSERV.VLRUNIT'
      Precision = 18
      Size = 2
    end
    object TITServFTVLRTOT: TIBBCDField
      FieldName = 'VLRTOT'
      Origin = 'ITFCHTECSERV.VLRTOT'
      Precision = 18
      Size = 2
    end
  end
  object UITServFT: TIBUpdateSQL
    RefreshSQL.Strings = (
      'Select '
      '  COD_ITFCHTECSERV,'
      '  COD_FCHTECPROD,'
    ...
    ModifySQL.Strings = (
      ...
      '  VLRTOT = :VLRTOT'
      'where'
      '  COD_ITFCHTECSERV = :OLD_COD_ITFCHTECSERV')
    InsertSQL.Strings = (
      'insert into ITFCHTECSERV'
      
        '  (COD_ITFCHTECSERV, COD_FCHTECPROD, COD_SUBSERVICO, QTDUTILIZ, ' +
        'CLASS, '
      '   VLRUNIT, VLRTOT)'
      'values'
      
        '  (:COD_ITFCHTECSERV, :COD_FCHTECPROD, :COD_SUBSERVICO, :QTDUTIL' +
        'IZ, :CLASS, '
      '   :VLRUNIT, :VLRTOT)')
    DeleteSQL.Strings = (
      'delete from ITFCHTECSERV'
      'where'
      '  COD_ITFCHTECSERV = :OLD_COD_ITFCHTECSERV')
    Left = 406
    Top = 228
  end
  object DITServFT: TDataSource
    DataSet = TITServFT
    Left = 407
    Top = 271
  end
  ...
  object UDesp: TIBUpdateSQL
    ...
    InsertSQL.Strings = (
      ...
      '   CFOP, COMISSAO, ALIQISSQN, DESCNF, CST)'
      'values'
  ...
  object TSlaveServ: TIBQuery
    ...
    SQL.Strings = (
        ...
        'select despadic.cod_gerador, despadic.qtd, despadic.vlrfinal, de' +
        'spadic.vlrtotfin,'
      'despadic.despesa'
      'from despadic'
      
        'where (despadic.cod_gerador=:CODIGO) AND (despadic.gerador='#39'ORDE' +
        'M'#39')')
    Left = 178
    Top = 318
    ParamData = <
  ...
  object UCodBarra: TIBUpdateSQL
    ...
    ModifySQL.Strings = (
      ...
      'where'
      '  COD_CODBARRA = :OLD_COD_CODBARRA')
    InsertSQL.Strings = (
      'insert into CODIGOBARRA'
      '  (COD_CODBARRA, COD_ESTOQUE, CODBARRA, CODFORNERC)'
      'values'
      '  (:COD_CODBARRA, :COD_ESTOQUE, :CODBARRA, :CODFORNERC)')
    DeleteSQL.Strings = (
