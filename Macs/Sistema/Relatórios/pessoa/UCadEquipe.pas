...
procedure TFCadEquipe.AtualizaEquipe;
   begin
       DMPESSOA.TALX1.Close;
       DMPESSOA.TALX1.SQL.Clear;
       DMPESSOA.TALX1.SQL.Add('select equipe.cod_equipe, equipe.descricao, equipe.cod_responsavel, equipe.observacao, funcionario.cod_func, funcionario.cod_pessoa, pessoa.cod_pessoa, pessoa.nome ');
