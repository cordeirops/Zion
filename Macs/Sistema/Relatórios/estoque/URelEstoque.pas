...
Begin
   ...
   DMESTOQUE.TProduto.SQL.Add('Select * from Produto Where (Produto.COD_LOJA=:CODLOJA)');
   ...
   If Not DMESTOQUE.TProduto.IsEmpty
   Then Begin
   ...
   DMESTOQUE.TransacEstoque.CommitRetaining;
	Alx.Close;
	Alx.SQL.Clear;
	Alx.SQL.Add('Select grupoprod.descricao as GRUPO, subgrupoprod.descricao as SUBGRUPO, produto.descricao as PRODUTO, ');
...
//   DMESTOQUE.TRel.SQL.Add(' AND (estoque.estfisico>0) ');
   ...
   If AbreTabela=True
   Then Begin
	   FSRel.LoadFromFile('C:\Orion\MACS\Rel\FRFPRODVENDAOS.frf');
      FSRel.ShowReport;
   End;
End;
...
//   DMESTOQUE.TRel.SQL.Add(' AND (estoque.estfisico>0) ');
   ...
   If AbreTabela=True
   Then Begin
	   FSRel.LoadFromFile('C:\Orion\MACS\Rel\FRFPRODVENDA_CLASS_PROD.frf');
      FSRel.ShowReport;
   End;
End;
...
Begin
   ...
   Try
   	...
   	If AbreTabela=True
   	Then Begin
	   		FSRel.LoadFromFile('C:\Orion\MACS\Rel\FrfProdVenda_OP.frf');
      		FSRel.ShowReport;
   	End;
   Finally
...
Begin
   ...
   If AbreTabela=True
   Then Begin
	   FSRel.LoadFromFile('C:\Orion\MACS\Rel\FRFESTCALC.frf');
      FSRel.ShowReport;
   End;
   Finally
   	PComunica.Visible:=False;
...
begin
   ...
   If AbreTabela=True
   Then Begin
      FSRel.LoadFromFile('C:\Orion\MACS\Rel\FRFPRODVENDA_TotalProd.frf');
      FSRel.ShowReport;
   End;
end; 
...
Begin
   ...
   If AbreTabela=True
   Then Begin
      FSRel.LoadFromFile('C:\Orion\MACS\Rel\FrfPosEstoque_MaxMin.frf');
      FSRel.ShowReport;
   End;
End;
...
//   DMESTOQUE.TRel.SQL.Add(' AND (estoque.estfisico>0) ');
   ...
   If AbreTabela=True
   Then Begin
	   FSRel.LoadFromFile('C:\Orion\MACS\Rel\FrfProdCompra_Class_Prod.frf');
      FSRel.ShowReport;
   End;
End;
//Imprime Relatório de produtos devolvidos de vendas
...
//   DMESTOQUE.TRel.SQL.Add(' AND (estoque.estfisico>0) ');
   ...
   If AbreTabela=True
   Then Begin
	   FSRel.LoadFromFile('C:\Orion\MACS\Rel\FrfProdCompra_DEV_Class_Prod.frf');
      FSRel.ShowReport;
   End;
End;
...
Begin
   ...
   If AbreTabela=True
   Then Begin
	   FSRel.LoadFromFile('C:\Orion\MACS\Rel\FrfLstPrecestComp.frf');
      FSRel.ShowReport;
   End;
End;
...
Begin
   ...
   If AbreTabela=True
   Then Begin
	   FSRel.LoadFromFile('C:\Orion\MACS\Rel\FrfLstPrecest.frf');
      FSRel.ShowReport;
   End;
End;
//Imprime Relatório de Lotes vencidos
...
Begin
   ...
   If AbreTabela=True
   Then Begin
	   FSRel.LoadFromFile('C:\Orion\MACS\Rel\FrfLstLoteVenc.frf');
      FSRel.ShowReport;
   End;
End;
//Imprime Relatório de Lista de Preços para venda
...
Begin
   ...
   If AbreTabela=True
   Then Begin
	   FSRel.LoadFromFile('C:\Orion\MACS\Rel\FrfLstVend.frf');
      FSRel.ShowReport;
   End;
End;
   ...
   Then Begin
       ...
       Begin
           ...
           //VENDA
			DMESTOQUE.Alx.Close;
       	DMESTOQUE.Alx.SQL.Clear;
       	DMESTOQUE.Alx.SQL.Add('SELECT SUM(itenspedven.qtdeprod) AS QTD From itenspedven Where (itenspedven.cod_estoque=:CODESTOQUE) ');
           ...
           //COMPRA
			DMESTOQUE.Alx.Close;
       	DMESTOQUE.Alx.SQL.Clear;
       	DMESTOQUE.Alx.SQL.Add('SELECT SUM(itenspedc.qtdeprod) AS QTD From itenspedc Where (itenspedc.cod_estoque=:CODESTOQUE) ');
           If (EDData1.Text<>'  /  /    ') And (EDData2.Text<>'  /  /    ') Then
           	DMESTOQUE.Alx.SQL.Add(' AND ((itenspedc.Data>=:DATA1) And (itenspedc.Data<=:DATA2)) ');
			DMESTOQUE.Alx.ParamByName('CODESTOQUE').AsString:=DMESTOQUE.TRel.FieldByName('COD_ESTOQUE').AsString;
           If (EDData1.Text<>'  /  /    ') And (EDData2.Text<>'  /  /    ')
      ...
      DMESTOQUE.TRel.SQL.Add('        vwsimilar.codfabricante AS FABRICANTE, vwsimilar.descricao AS SUBPRODUTO, produto.descricao AS PRODUTO, ');
      DMESTOQUE.TRel.SQL.Add('        tmp.vlr1 AS ESTOQUE, tmp.vlr2 AS COMPRA, tmp.vlr3 AS VENDA ');
      DMESTOQUE.TRel.SQL.Add(' from tmp ');
      ...
      Then Begin
	   ...
	   Else Begin
	   		FSRel.LoadFromFile('C:\Orion\MACS\Rel\FrfEntXSai.frf');
      		FSRel.ShowReport;
      End;
   End;
End;
...
{   If RgOrdenacao.ItemIndex=0 Then
   ...
   If AbreTabela=True
   Then Begin
	   FSRel.LoadFromFile('C:\Orion\MACS\Rel\FrfLstEstPedCliDC.frf');
      FSRel.ShowReport;
   End;
End;
//Imprime Relatório de Lista de preços para clientes em 2 colunas
...
Begin
   ...
   If AbreTabela=True
   Then Begin
	   FSRel.LoadFromFile('C:\Orion\MACS\Rel\FrfLstPreco2Colunas.frf');
      FSRel.ShowReport;
   End;
End;
...
Begin
   ...
   Then Begin
      If (FMenu.TIPOREL='POSEST') Then
	        FSRel.LoadFromFile('C:\Orion\MACS\Rel\FrfPosEstoque_Class.frf');
      If (FMenu.TIPOREL='LISTACONTAGEM') Then
	        FSRel.LoadFromFile('C:\Orion\MACS\Rel\FrfListaContagem.frf');
      FSRel.ShowReport;
   End;
End;
...
Begin
   ...
   If AbreTabela=True
   Then Begin
  	   FSRel.LoadFromFile('C:\Orion\MACS\Rel\FrfLANCENT.frf');
      FSRel.ShowReport;
   End;
End;
...
Begin
   ...
   If AbreTabela=True
   Then Begin
  	   FSRel.LoadFromFile('C:\Orion\MACS\Rel\FrfLANCSAI.frf');
      FSRel.ShowReport;
   End;
End;
...
Begin
   ...
   If AbreTabela=True
   Then Begin
	   FSRel.LoadFromFile('C:\Orion\MACS\Rel\FrfInventEst.frf');
      FSRel.ShowReport;
   End;
End;
...
{   	DMESTOQUE.TRel.e
       ...
       DMESTOQUE.CDS.SaveToFile('C:\Orion\Arquivos\Produtos.xml');
      	MessageDlg('Arquivo salvo como: '+#39+'C:\Orion\Arquivos\Produtos.xml'+#39, mtWarning, [mbOK], 0);
	End;
End;
//Salva em txt Relatório de lista com descricao para cupom
...
Begin
   ...
   Then Begin
       ...
       Writeln(XTexto, '');
       Writeln(XTexto, '-------------------------------------------------------------------------------------------------------');
       Writeln(XTexto, '                         Orion Software Ltda - Sistemas de Gestão Empresarial                          ');
       Writeln(XTexto, '                                       www.orionsoftware.com.br                                        ');
       CloseFile(Xtexto);
      	MessageDlg('Arquivo salvo como: '+#39+'C:\Inventario.txt'+#39, mtWarning, [mbOK], 0);
   End;
End;
...
Begin
   ...
   If AbreTabela=True
   Then Begin
	   FSRel.LoadFromFile('C:\Orion\MACS\Rel\FrfEstoque_ClassProd.frf');
      FSRel.ShowReport;
   End;
End;
...
Begin
	If (EdData1.Text<>'  /  /    ') AND (EdData2.Text<>'  /  /    ')
  	Then Begin
   	//ITENS PEDIDO COMPRA
   	If (FMenu.TIPOREL='FRFPRODVENDDEV')
       Then Begin
...
Begin
   ...
   Then Begin
   	...
   	End
		Else Begin
          If (CBEstMin.Checked=False) And (CBEstMax.Checked=False) Then
   ...
   Then Begin
   	...
   	ImpRLancSai;// Imprime relatório de Lancamentos de Saida
   End;
...
begin
  inherited;
	...
	If FMenu.TIPOREL='LISTVEND' Then
...
begin
  inherited;
   ...
   If (FMenu.TIPOREL='ENTXSAIMENS') or (FMenu.TIPOREL='ENTXSAI') or (FMenu.TIPOREL='FRFPRODVENDA_CLASS_PROD')  or (FMenu.TIPOREL='FRFPRODCOMPRA_DEV_CLASS_PROD') or (FMenu.TIPOREL='FRFPRODCOMPRA_CLASS_PROD') or (FMenu.TIPOREL='LANCENT') or (FMenu.TIPOREL='LANCSAI') or (FMenu.TIPOREL='FRRESUMOVC') or (FMenu.TIPOREL='IMPRELLOTE')  or (FMenu.TIPOREL='FRFPRODOS') or (FMenu.TIPOREL='FRFPRODVEND') or (FMenu.TIPOREL='FRFPRODVENDA_TotalProd')
   Then Begin
       PData.Visible:=true;
       PData.BringToFront;
   End
   Else Begin
       PData.Visible:=False;
   End;
   If (FMenu.TIPOREL='ENTXSAIMENS') Then
   ...
   Then Begin
   	LDescTitulo.Caption:='Relatório de produtos vendidos';
		CBEstPos.Visible:=False;
   End;
	If  FMenu.TIPOREL='FRRESUMOVC' Then
