...
Var
   ...
   codCOFINS, PIS,PISST, codPIS, dest, referenciada, ide, produtos, TotalIss, totalICMS, total, especifico, produto, auxiliar, combustivel, autXml, infRespTec: String;
...
Begin
   ...
   Try
       ...
       total := Util.total(totalICMS, ''{TotalIss}, '');
